...
namespace Pinsonault.Application.Dey
{
    ...
    public class DeyRestrictionsDrilldownReport : Report
    {
        protected override Dictionary<string, CriteriaItem> LoadCriteriaItems(NameValueCollection filters)
        {
            //Get base items - includes Market Basket and Section (among others)
        ...
        protected override void BuildReportDefinitions()
        {
            ReportDefinitions.Add(new DrilldownReportDefinition { ReportKey = "deyrestrictionsdrilldownreport", Tile = "Tile4Tools", EntityTypeName = "RestrictionsReportDrilldown", Sort = "Formulary_Lives desc", SectionTitle = "QL Restrictions Drilldown Report" });
        }
