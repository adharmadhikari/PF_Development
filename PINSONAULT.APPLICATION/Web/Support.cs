...
namespace Pinsonault.Web
{
    public class Identifiers
    {
        ...
        public const int ReimbursementChallengeReport = 22;
        public const int PCNBINReport = 23;
    }
    ...
    public class Support
    {
        ...
        /// <param name="Body">Body of the message.</param>
        /// <param name="IsHTML">Indicates if the body of the message contains HTML markup.</param>
        /// <param name="MailPriority">Sets the priority of the mail message
        /// <returns></returns>
        public static bool SendEmail(string From, string To, string CC, string Subject, string Body, bool IsHTML,System.Net.Mail.MailPriority Priority)
        {
            try
            {
                CorrectFromEmail(From, Subject);
