...
/// <summary>
/// Summary description for ReckittReportClasses
/// </summary>
//for reckitt ccr
...
{    
    public class CCRProductReportDefinition : ReportDefinition
    {
        ...
        protected override QueryDefinition CreateQueryDefinition(NameValueCollection filters)
        {
            ...
            if (!string.IsNullOrEmpty(strwhere))
            {
                using (Pinsonault.Application.Reckitt.PathfinderReckittEntities rContext = new Pinsonault.Application.Reckitt.PathfinderReckittEntities())
                {
