<%@ Page Title="PowerPlanRx - My Campaigns" Language="C#" MasterPageFile="~/MasterPage.master" Theme="impact" AutoEventWireup="true" CodeFile="mycampaigns_current.aspx.cs" Inherits="mycampaigns_current" %>
...
<asp:SqlDataSource ID="dsMyCampaigns" runat="server"  ConnectionString="<%$ ConnectionStrings:impact %>" 
 SelectCommand="usp_GetCampaignInfo_By_Novo_User_ID" SelectCommandType="StoredProcedure" OnSelecting="OnSelecting"> 
</asp:SqlDataSource>
