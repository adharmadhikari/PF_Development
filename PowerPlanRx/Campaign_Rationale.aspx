<%@ Page Title="Campaign Rationale" Language="C#" MasterPageFile="~/masterpages/Popup.master" Theme="impact" AutoEventWireup="true" CodeFile="Campaign_Rationale.aspx.cs" Inherits="Campaign_Rationale" %>
...
<asp:FormView runat="server" ID="frmPlanBrandInfo" DataSourceID="dsPlanBranInfo" Width="100%">
...
<asp:Panel ID="pnlRationale" runat="server" CssClass="rationale">
    ...
    <asp:Label ID="lblReqdRationals" runat="server" Text= "Please select a rationale for the Campaign." Visible="false"></asp:Label>
    
    <asp:SqlDataSource ID="dsRationale" runat="server" ConnectionString="<%$ ConnectionStrings:impact %>"
        SelectCommand="usp_GetRationaleByBrandID" SelectCommandType="StoredProcedure">
        <SelectParameters>
 ...
 <asp:Panel ID="pnlAlert" runat="server">
   ...
   <asp:SqlDataSource ID="dsPlanBranInfo" runat="server" ConnectionString="<%$ ConnectionStrings:impact %>"
        SelectCommand="usp_GetPlanBrandInfo" SelectCommandType="StoredProcedure">
        <SelectParameters>
