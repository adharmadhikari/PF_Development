<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" Theme="impact" Title="PowerPlanRx - Step 1 Timeline" AutoEventWireup="true" CodeFile="createcampaign_step1_timeline.aspx.cs" Inherits="createcampaign_step1_timeline" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    ...
    <asp:SqlDataSource runat="server" ID="dsCampaignInfo" ConnectionString='<%$ ConnectionStrings:impact %>'
            SelectCommand="usp_GetCampaign_Timeline" SelectCommandType="StoredProcedure"
            UpdateCommand="usp_Campaign_UpdateTimeline" UpdateCommandType="StoredProcedure"
            >
        <SelectParameters>
