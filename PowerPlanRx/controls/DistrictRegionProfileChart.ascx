<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DistrictRegionProfileChart.ascx.cs" Inherits="controls_DistrictRegionProfileChart" %>

<DCWC:Chart ID="ChartComm" runat="server"  
...
<DCWC:Chart ID="ChartOther" runat="server" 
    Height="400px" Width="1000px" 
    ImageStorageMode="UseHttpHandler" ImageType="Jpeg">
    <Legends>
        <DCWC:Legend Name="Default" Enabled="false">
