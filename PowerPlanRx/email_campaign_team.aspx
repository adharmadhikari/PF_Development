<%@ Page Title="Campaign Team" Language="C#" MasterPageFile="~/MasterPages/Popup.master" Theme="impact" AutoEventWireup="true" CodeFile="email_campaign_team.aspx.cs" Inherits="email_campaign_team" %>
...
<asp:SqlDataSource ID="dsCampaignMeetingEmail" runat="server" ConnectionString="<%$ ConnectionStrings:impact %>"
    SelectCommand="usp_GetCampaignEmailInfo_By_Campaign_Id" 
...
<asp:SqlDataSource ID="dsGetEmailAddresses" runat="server" ConnectionString="<%$ ConnectionStrings:impact %>" 
    SelectCommand="usp_GetCampaignEmailAddresses_By_Campaign_Id" 
    SelectCommandType="StoredProcedure" >
    <SelectParameters>
        <asp:QueryStringParameter Name="Campaign_ID" QueryStringField="id" />
    </SelectParameters>
