<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Title="PowerPlanRx - Step 2 Summary" Theme="impact" CodeFile="createcampaign_step2_summary.aspx.cs" Inherits="createcampaign_step2_summary" %>
...
<%@ Register Src="~/controls/Messages.ascx" TagName="Messages" TagPrefix="pinso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    ...
    <asp:SqlDataSource ID="dsCampaignInfo" runat="server" ConnectionString="<%$ ConnectionStrings:impact %>" SelectCommand="usp_GetCampaignSummaryInfoByCampaignID" SelectCommandType="StoredProcedure" >
        <SelectParameters>
