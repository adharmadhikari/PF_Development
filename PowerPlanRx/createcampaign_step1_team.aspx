<%@ Page Title="Campaign Team" Language="C#" MasterPageFile="~/MasterPage.master" Theme="impact" AutoEventWireup="true" CodeFile="createcampaign_step1_team.aspx.cs" Inherits="createcampaign_step1_team" %>
...
<asp:FormView ID="frmCampaignTeam" runat="server" DataSourceID="dsCampaignTeam" Width="100%" Visible="false">
    <ItemTemplate>
        ...
        <table class="CampaignTeam" cellpadding="0" cellspacing="0">
            <tr>
                <td class="label">Function Area:</td><td> <telerik:RadComboBox  EnableEmbeddedSkins="false"  SkinID="impactGen" ID="drpFunctionArea" runat="server" DataSourceID="dsFunctionArea" DataTextField="Title_Name" 
        DataValueField="Title_ID" AutoPostBack="true" AppendDataBoundItems="true" 
        OnSelectedIndexChanged="OnFunctionAreaChanged" Width="180">
            <Items>
                <telerik:RadComboBoxItem   Value="0" Text="-- Select a Function Area --" />
            </Items>
        </telerik:RadComboBox>        
                </td>
                <td class="label">Employee Name:</td><td> <telerik:RadComboBox EnableEmbeddedSkins="false"  SkinID="impactGen" ID="drpEmpName" runat="server" DataSourceID="dsEmpNames" DataTextField="Full_Name"
        DataValueField="Territory_ID" AppendDataBoundItems="true" Width="200" >
            <Items>
                <telerik:RadComboBoxItem Value="0" Text="-- Select an Employee Name --" />
            </Items>
   ...
   <Columns>
        ...
        <asp:TemplateField HeaderText="Remove From Team" Visible="false">
            ...
            <pinso:CustomButton runat="server" ID="btnDelete" Text="Delete" 
                Visible='<%# (((int)Eval("Title_ID") != 1) && ((int)Eval("Title_ID") != 4) && ((int)Eval("Title_ID") != 8)) %>' 
...
<asp:FormView ID="frmAdHoc" runat="server" DataSourceID="dsCampaignTeam" 
    ...
    <ItemTemplate>  
       ...
       <table class="CampaignTeamExtended" cellpadding="0" cellspacing="0">
           <tr>
                <td>Function Area:</td><td>
...
<asp:GridView ID="grvAdHocCampaign" CssClass="FunctionAreas" DataSourceID="dsAdHocCampaignTeam" runat="server" 
    Width="100%" AutoGenerateColumns="False"  
        DataKeyNames="Campaign_Adhoc_Team_ID" AllowSorting="True" 
        RowStyle-Height="25" HorizontalAlign="Center" EmptyDataText="No Ad Hoc Team members have been added">
   <Columns>
        <asp:BoundField DataField="Campaign_Adhoc_Team_ID" Visible="false" />
...
<asp:SqlDataSource ID="dsCampaignTeam" runat="server" ConnectionString="<%$ ConnectionStrings:impact %>"
    SelectCommand="usp_GetCampaignTeam_By_Campaign_Id" 
    DeleteCommand="usp_DeleteCampaignTeam_By_Territory_Id"
...
<asp:SqlDataSource ID="dsAdHocCampaignTeam" runat="server" ConnectionString="<%$ ConnectionStrings:impact %>"
    SelectCommand="usp_GetAdHocCampaignTeam_By_Campaign_Id" 
    DeleteCommand="usp_DeleteAdHocCampaignTeam_By_Id"
    SelectCommandType="StoredProcedure" DeleteCommandType="StoredProcedure">
    <SelectParameters>
        <asp:QueryStringParameter Name="Campaign_ID" QueryStringField="id" />
    </SelectParameters> 
    <DeleteParameters>
        <asp:Parameter Name="Campaign_Adhoc_Team_ID" Type="Int32" />
    </DeleteParameters>
</asp:SqlDataSource> 

<asp:SqlDataSource ID="dsFunctionArea" runat="server" 
    ConnectionString="<%$ ConnectionStrings:impact %>" 
    SelectCommand="usp_GetFunctionArea" SelectCommandType="StoredProcedure">
</asp:SqlDataSource>

<asp:SqlDataSource ID="dsEmpNames" runat="server" 
    ConnectionString="<%$ ConnectionStrings:impact %>" 
     SelectCommand="usp_GetEmployeeName" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:ControlParameter ControlID="ctl00$main$frmCampaignTeam$drpFunctionArea" Name="Title_ID" PropertyName="SelectedValue" DefaultValue="0"/>
        <asp:QueryStringParameter Name="Campaign_ID" QueryStringField="id" />
    </SelectParameters>
</asp:SqlDataSource>
