...
public partial class mycampaigns_current : System.Web.UI.Page
{
    ...
    {
        ((SqlParameterCollection)e.Command.Parameters).AddWithValue("@Novo_User_ID", HttpContext.Current.User.Identity.Name);
        ((SqlParameterCollection)e.Command.Parameters).AddWithValue("@Title_ID", HttpContext.Current.Session["titleId"]);
        ((SqlParameterCollection)e.Command.Parameters).AddWithValue("@Territory_ID", HttpContext.Current.Session["territoryId"]);
    }
}
