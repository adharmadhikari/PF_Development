...
<div class="clearAll"></div>
    ...
    <asp:SqlDataSource runat="server" ID="dsMessageAvailable" ConnectionString='<%$ConnectionStrings:impact %>' 
      SelectCommand="usp_Campaign_Messages_AvailableList" SelectCommandType="StoredProcedure" >
        <SelectParameters>
...
<asp:SqlDataSource runat="server" ID="dsMessageSelected" ConnectionString='<%$ ConnectionStrings:impact %>' 
      SelectCommand="usp_Campaign_Messages_SelectedList" 
        SelectCommandType="StoredProcedure" ProviderName="System.Data.SqlClient" 
        
        UpdateCommand="usp_Campaign_UpdateMessages" 
        UpdateCommandType="StoredProcedure" 
        DeleteCommand="usp_Campaign_Messages_SelectedList_Delete" 
