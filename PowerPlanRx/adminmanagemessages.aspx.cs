...
public partial class adminmanagemessages : System.Web.UI.Page
{
    ...
    protected void OnSave(object sender, EventArgs args)
    {
        ...
        try
        {
            ...
            cmd = new SqlCommand("usp_Admin_UpdateMessage", cn, tran);
            ...
            foreach ( GridDataItem item in radGrid.Items )
            {
                ...
                //{
                    id = Convert.ToInt32(item.GetDataKeyValue("Message_ID"));

                    cmd.Parameters.Clear();
                    cmd.Parameters.AddWithValue("@Message_ID", id);
                    cmd.Parameters.AddWithValue("@Message_Update_ID", item.GetDataKeyValue("Message_Update_ID"));
                    cmd.Parameters.AddWithValue("@Brand_ID", brandID);
                    cmd.Parameters.AddWithValue("@Message_Name", ((TextBox)item.FindControl("txtName")).Text);                    
