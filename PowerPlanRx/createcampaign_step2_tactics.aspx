<%@ Page  Language="C#"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Theme="impact" 
  CodeFile="createcampaign_step2_tactics.aspx.cs" Inherits="createcampaign_step2_tactics" 
   Title="PowerPlanRx - Step 2 Tactics" %>
<%@ Register Src="~/controls/Tactics.ascx" TagName="Tactics" TagPrefix="pinso" %>
...
<div class="tileSubHeader">
 ...
 <telerik:RadGrid runat="server" EnableEmbeddedSkins="false" SkinID="table1"  ID="rgTacticsAdd" AutoGenerateColumns="false" DataSourceID="dsTacticsAvailable" 
   AllowSorting="true" AllowPaging="false">
        ...
        <MasterTableView AutoGenerateColumns="false" ClientDataKeyNames="Tactics_ID" DataKeyNames="Tactics_ID" >
            <Columns>  
     ...
     <%-- Thumbnail --%>          
            ...
            <%-- Thumbnail End  --%> 
                ...
                <telerik:GridBoundColumn DataField="Tactics_Name" HeaderText="Tactic Name"  HeaderStyle-Width="16%"   />
                <telerik:GridBoundColumn DataField="Tactics_Description" HeaderText="Tactic or Program Description"  HeaderStyle-Width="50%"   />
...
<asp:SqlDataSource runat="server" ID="dsTacticsAvailable" ConnectionString='<%$ConnectionStrings:impact %>' 
      SelectCommand="usp_Campaign_Tactics_AvailableList" SelectCommandType="StoredProcedure" >
        <SelectParameters>
    ...
    <MasterTableView DataKeyNames="Campaign_ID, Tactics_ID" >
        <Columns>
            ...
            <%-- Thumbnail End  --%> 
                ...
                <telerik:GridBoundColumn DataField="Tactics_Name" HeaderText="Tactic Name" UniqueName="Tactics_Name" ReadOnly="true"   />
                <telerik:GridBoundColumn DataField="Tactics_Description" HeaderText="Tactic or Program Description" UniqueName="Tactics_Description" ReadOnly="true"   />
              
                <telerik:GridTemplateColumn HeaderText="Qty Needed" ItemStyle-CssClass="alignRight">
                     <ItemTemplate>
                     
                        <telerik:RadTextBox ID="rtxtQtyEdit" runat="server" Text='<%# Bind("Qty") %>'  Width="50px" onblur="cleanInput(this)"
...
<asp:SqlDataSource runat="server" ID="dsTacticsSelected" ConnectionString='<%$ ConnectionStrings:impact %>' 
      SelectCommand="usp_Campaign_Tactics_SelectedList" 
        SelectCommandType="StoredProcedure" ProviderName="System.Data.SqlClient" 
        
        UpdateCommand="usp_Campaign_UpdateTactics" 
        UpdateCommandType="StoredProcedure" 
        DeleteCommand="usp_Campaign_Tactics_SelectedList_Delete" 
