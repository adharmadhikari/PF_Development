    ...
    public partial class Campaign
    {
        ...
        public static DataTable GetCampaignProductFormulary(int iCampaignID)
        {
            ...
            try
            {
                ...
                return SqlHelper.ExecuteDataset(cn, "usp_GetCampaignProductFormulary", arParams).Tables[0];                
            }
            catch
            {
                throw;
        ...
        public static void UpdateCampaignProductFormulary(int iCampaignID, int iProductID, string strProduct_Tier, string strProduct_Copay, string strProduct_PA_Comment, string strProduct_QL_Comment, string strProduct_ST_Comment, string strModifiedBy)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(cn, "usp_UpdateCampaignProductFormulary", arParams);
        ...
        /// </summary>
        /// <param name="iCampaignID"></param>
        /// <param name="strTotalLives"></param>
        /// <param name="strPharmacylives"></param>
        ...
        /// <param name="strNational_Account_Affiliates"></param>
        /// <param name="strPBM_Affiliation"></param>
        ...
        public static void UpdateCampaignPlanInfo(int iCampaignID, int? iTotalLives, int? iPharmacylives, bool bFormulary_Change_Status,
                                                  System.Data.SqlTypes.SqlDateTime dtFormulary_Change_Eff_Date, bool bPlan_Participation_PT, string strKey_Employers,
                                                  string strAffiliated_Phys_Groups, string strNational_Account_Affiliates, string strPBM_Affiliation,
                                                  string strPlan_Penetrate_Region, string strContract_Share_Goal, string strOther_Facts1,
                                                  string strOther_Facts2,string strOther_Facts3, string strOther_Facts4, string strModifiedBy)
        {            
            //update campaign product formulary
            SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["impact"].ConnectionString);
            try
            {
                ...
                arParams[0] = new SqlParameter("@Campaign_ID", iCampaignID);
                arParams[1] = new SqlParameter("@Total_Lives", iTotalLives);
                arParams[2] = new SqlParameter("@Pharmacy_Lives", iPharmacylives);
                arParams[3] = new SqlParameter("@Formulary_Change_Status", bFormulary_Change_Status);
                arParams[4] = new SqlParameter("@Formulary_Change_Eff_Date", dtFormulary_Change_Eff_Date);
                arParams[5] = new SqlParameter("@Plan_Participation_PT", bPlan_Participation_PT);
                arParams[6] = new SqlParameter("@Key_Employers", strKey_Employers);
                arParams[7] = new SqlParameter("@Affiliated_Phys_Groups", strAffiliated_Phys_Groups);
                arParams[8] = new SqlParameter("@National_Account_Affiliates", strNational_Account_Affiliates);
                arParams[9] = new SqlParameter("@PBM_Affiliation", strPBM_Affiliation);
                arParams[10] = new SqlParameter("@Plan_Penetrate_Region", strPlan_Penetrate_Region);
                arParams[11] = new SqlParameter("@Contract_Share_Goal", strContract_Share_Goal);
                arParams[12] = new SqlParameter("@Other_Facts1", strOther_Facts1);
                arParams[13] = new SqlParameter("@Other_Facts2", strOther_Facts2);
                arParams[14] = new SqlParameter("@Other_Facts3", strOther_Facts3);
                arParams[15] = new SqlParameter("@Other_Facts4", strOther_Facts4);
                arParams[16] = new SqlParameter("@Modified_BY", strModifiedBy);                

                SqlHelper.ExecuteNonQuery(cn, "usp_Campaign_UpdatePlanProfile", arParams);
        ...
        public static void UpdateCampaignTeam(int campaignID, string territoryID, int userID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(cn, "usp_UpdateCampaignTeam", arParams);
        ...
        public static void UpdateAdHocCampaignTeam(int campaignID, string adHocName, int titleID, string adHocEmail, string adHocPhone, int userID)
        {
            ...
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(cn, "usp_UpdateAdHocCampaignTeam", arParams);
        ...
        /// <returns></returns>
        public static int CreateCampaign(string strPlanID, int iBrandID, string strTerritoryID, string strUserID, string strRationals)
        {
            SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["impact"].ConnectionString);
            int iCampaign_ID = 0;
            try
            {
                ...
                iCampaign_ID = System.Convert.ToInt32(SqlHelper.ExecuteScalar(cn, "usp_InsertCampaignInfo", arParams));
                return iCampaign_ID;
            }
            catch
            {
        ...
        /// <param name="strUserID"></param>
        /// <returns></returns>
        public static int UpdateCampaignRationale(int iCampaignID, string strRationals, string strUserID)
        {
            SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["impact"].ConnectionString);
            ...
            try
            {
                ...
                arParams[0] = new SqlParameter("@Campaign_ID", iCampaignID);
                arParams[1] = new SqlParameter("@Campaign_Rationale", strRationals);
                arParams[2] = new SqlParameter("@Modified_BY", strUserID);

                return SqlHelper.ExecuteNonQuery(cn, "usp_Campaign_UpdateRationale", arParams);
            }
            catch
            {
                throw;
        ...
        public static bool IsCampaignActive(int iCampaignID)
        {
            ...
            bActive = System.Convert.ToBoolean(SqlHelper.ExecuteScalar(cn, "usp_Campaign_IsActive", arParams));
            return bActive; 
        }
        public static int GetExistingActiveCampaignID(string strPlan_ID, int iBrandID, string strTerritoryID)
        {
            ...
            iCampaignID = Convert.ToInt32(SqlHelper.ExecuteScalar(cn, "usp_GetCampaignID", arParams));
            return iCampaignID;
        }
        ...
        public static DataSet GetPhysList(string strDist_ID, int iCampaignID)
        {
            ...
            return SqlHelper.ExecuteDataset(cn, "usp_GetPhysicianListByDistrictID", arParams);
        ...
        public static DataTable GetSVBaseByDistrictSegmentBrandID(string strDistrict_ID, int iBrandID, int iSegment_ID)
        {
            ...
            return SqlHelper.ExecuteDataset(cn, "usp_GetSV_BaseByDistrictIDBrandID", arParams).Tables[0];            
        }
        /// <summary>
        ...
        public static DataTable GetSVBaseByRegionDistrictSegmentBrandID(string strType_ID, string strRegion_ID, string strDistrict_ID, int iBrandID, int iSegment_ID)
        {
            ...
            return SqlHelper.ExecuteDataset(cn, "usp_GetSV_BaseByRegionIDDistrictIDBrandID", arParams).Tables[0];
        }
        ...
        public static DataSet dsSVBaseByRegionDistrictSegmentBrandID(string strType_ID, string strRegion_ID, string strDistrict_ID, int iBrandID, int iSegment_ID)        
        {
            ...
            return SqlHelper.ExecuteDataset(cn, "usp_GetSV_BaseByRegionIDDistrictIDBrandID", arParams);
        }
        ...
        public static int UpdatePhaseIDByCampaignIDReqdPhaseID(int iCampaignID, int iRequiredPhaseID)
        {
            ...
            return SqlHelper.ExecuteNonQuery(cn, "usp_UpdateCampaignPhaseByCampaignID", arParams);
        }
        /// <summary>
        ...
        {            
            ...
            return SqlHelper.ExecuteDataset(cn, "usp_Report_GetExcelRowDetails",arParams).Tables[0];
        }
        /// <summary>
        ...
        public static void InsertCampaignOpportunityData(int iCampaignID, int iSegmentID,string strTerritoryID, string strBrandList,string strAEName)
        {
            ...
            SqlHelper.ExecuteNonQuery(cn, "usp_Insert_Campaign_Opportunity_Archived_Data", arParams);            
        }
    }
}
