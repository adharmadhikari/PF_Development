...
public partial class MasterPageGoal : System.Web.UI.MasterPage
{
    /// <summary>
    ...
    public int PhaseID { get; set; }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["id"]) && pageName.StartsWith("createcampaign", StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                //////sl 10/25/2012 Goals
                //if (IsPageEditable && (!string.IsNullOrEmpty(Request.QueryString["id"]) && (pageName.StartsWith("createcampaign_step1_goals", StringComparison.InvariantCultureIgnoreCase))))
                //{
                //    btnSubmit.Attributes.Add("onclick", "this.disabled=false; return true");
        ...
        protected void OnSubmit(object sender, EventArgs e)
        {
            ...
            {
                //if Goals, add validation to Submit button
