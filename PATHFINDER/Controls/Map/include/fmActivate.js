...
function fmObjectActivateWrite(id, movie, width, height, play, quality, bgcolor, base, scale) {
//do: generate an object to activate

	var fm = fmObjectGetParams(id, movie, width, height, play, quality, bgcolor, base, scale);
	document.write(fmObjectGenerate(fm.attrs, fm.params));
}

function fmObjectGetParams(id, movie, width, height, play, quality, bgcolor, base, scale) {
