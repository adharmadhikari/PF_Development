<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SplitSection.master" AutoEventWireup="true" CodeFile="planinformation.aspx.cs" Inherits="todaysaccounts_wholesale_planinformation_Section2" %>
<%@ Register src="~/todaysaccounts/controls/PlanInfoDetailsWT.ascx" tagname="PlanInfoDetails" tagprefix="pinso" %>
<%@ Register src="~/todaysaccounts/controls/PlanInfoAddress.ascx" tagname="PlanInfoAddress" tagprefix="pinso" %>

<%-- Today's Accounts - WT -  Plan Information --%>
