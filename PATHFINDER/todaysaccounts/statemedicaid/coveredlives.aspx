<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/TriSection.master" AutoEventWireup="true" CodeFile="coveredlives.aspx.cs" Inherits="todaysaccounts_statemedicaid_coveredlives_Section2" %>
<%@ Register src="~/todaysaccounts/controls/CoveredLivesSM.ascx" tagname="CoveredLives" tagprefix="pinso" %>
<%@ Register src="~/todaysaccounts/controls/BenefitDesignSM.ascx" tagname="BenefitDesignSM" tagprefix="pinso" %>
...
<%-- Today's Accounts - State Medicaid -  Covered Lives / Benefit Design--%>
...
<asp:Content ID="Content7" ContentPlaceHolderID="Tile4" Runat="Server">
    <div id="benDsnTotal"> 
        <pinso:BenefitDesignSM ID="BenefitDesignSM1" runat="server" AllowSorting="true" OnClientRowSelected="gridSMBenefitDesg_rowclick"/>
    </div>
</asp:Content>
...
<asp:Content ID="Content10" ContentPlaceHolderID="Tile5" Runat="Server">
     <pinso:CoveredLivesDrillDown ID="CoveredLivesDrillDown1" runat="server" IsStateMedicaid="true"/>
</asp:Content>
