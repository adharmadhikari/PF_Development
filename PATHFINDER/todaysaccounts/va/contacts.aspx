<%@ Page  EnableViewStateMac="false"  Title="" Theme="pathfinder" Language="C#" MasterPageFile="~/MasterPages/SplitSectionHybrid.master" AutoEventWireup="true" CodeFile="contacts.aspx.cs" Inherits="todaysaccounts_commercial_contacts_Section2" %>
<%@ Register src="~/todaysaccounts/controls/KeyContactsListVA.ascx" tagname="VAKeyContactsList" tagprefix="pinso" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Tile3" Runat="Server">
    ...
    <pinso:VAKeyContactsList ID="KeyContactsList1" runat="server" />
