<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SingleSection.master" AutoEventWireup="true" CodeFile="affiliations.aspx.cs" Inherits="todaysaccounts_va_affiliations" %>
<%@ Register src="~/todaysaccounts/controls/AffiliationsListViewVA.ascx" tagname="AffiliationsListView" tagprefix="pinso" %>
...
<%-- Today's Accounts - VA -  Affiliations --%>
