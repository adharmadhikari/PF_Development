<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/TriSection.master" AutoEventWireup="true" EnableViewState="true" CodeFile="coveredlives.aspx.cs" Inherits="todaysaccounts_combined_coveredlives_Section2" %>
<%@ Register src="~/todaysaccounts/controls/CoveredLivesCombined.ascx" tagname="CoveredLives" tagprefix="pinso" %>
...
<%-- Today's Accounts - Combined -  Covered Lives / Benefit Design--%>
