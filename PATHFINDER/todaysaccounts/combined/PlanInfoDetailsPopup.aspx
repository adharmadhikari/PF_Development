<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Popup.master" AutoEventWireup="true" CodeFile="PlanInfoDetailsPopup.aspx.cs" Inherits="todaysaccounts_combined_PlanInfo" %>
...
<%-- Today's Accounts - Combined -  Plan Information Modal --%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="main" Runat="Server">    
    ...
    <div class="popupArea" id= "keycontactdiv" runat="server">
