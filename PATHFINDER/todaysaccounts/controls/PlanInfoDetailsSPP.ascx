<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PlanInfoDetailsSPP.ascx.cs" Inherits="todaysaccounts_controls_PlanInfoSPP" %>
    <asp:FormView runat="server" ID="formView" DataSourceID="dsPlanInfoDetails" CellPadding="0" CellSpacing="0" Width="100%">
        <ItemTemplate>
            ...
            <table class="genTable" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td><asp:Literal ID="Literal2" runat="server" Text='<%$ Resources:Resource, Label_Affiliation %>' /></td>
