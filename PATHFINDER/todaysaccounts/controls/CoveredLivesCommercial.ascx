<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CoveredLivesCommercial.ascx.cs" Inherits="controls_CoveredLivesCommercial" %>
<div id="lfView">
<%--    <asp:FormView runat="server" ID="frVwPICovLives" CssClass="totalCL" DataSourceID="dsPlanInfo" CellPadding="0" CellSpacing="0" Width="100%">
    ...
    <asp:EntityDataSource ID="dsCoveredLives" runat="server" EntitySetName="CoveredLivesCommercialSet" ConnectionString="name=PathfinderEntities" DefaultContainerName="PathfinderEntities" 
