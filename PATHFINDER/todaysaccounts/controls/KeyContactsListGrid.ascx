<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KeyContactsListGrid.ascx.cs" Inherits="todaysaccounts_controls_KeyContactsListGrid" %>
<div id="kcView">
     <telerik:RadGrid SkinID="radTable" runat="server" ID="gridKeyContacts" AllowSorting="true" AllowPaging="false" AllowFilteringByColumn="false" EnableEmbeddedSkins="false" PageSize="25">        
        <MasterTableView autogeneratecolumns="false" ClientDataKeyNames="KC_ID" AllowPaging="false" Width="100%" PageSize="25">
           <Columns>
            ...
            <telerik:GridBoundColumn DataField="KC_Title_Name" HeaderText='<%$ Resources:Resource, label_designation %>' HeaderStyle-Width="150px" SortExpression="KC_Title_Name" UniqueName="KC_Title_Name" />
            ...
            <telerik:GridHyperLinkColumn DataNavigateUrlFields="KC_Email" HeaderStyle-Width="200px" SortExpression="KC_Email" DataTextField="KC_Email" DataTextFormatString='{0}' DataNavigateUrlFormatString='mailto:{0}' HeaderText='<%$ Resources:Resource, label_email %>' UniqueName="KC_Email" />
        ...
        <ClientSettings>
            <DataBinding Location="~/todaysaccounts/services/pathfinderdataservice.svc" DataService-TableName="KeyContactBasicSet" SelectCountMethod="GetContactCount" />
