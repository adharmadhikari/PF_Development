<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PlanInfoDetailsMedicarePartA_B.ascx.cs" Inherits="todaysaccounts_controls_MedicarePartA_B" %>
    ...
    <asp:FormView runat="server" ID="formView" DataSourceID="dsPlanInfoDetails" CellPadding="0" CellSpacing="0" Width="100%">
        <ItemTemplate>
            ...
            <table class="genTable" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td><asp:Literal ID="Literal2" runat="server" Text='<%$ Resources:Resource, Label_Other_Name %>' /></td>
                    <td class="rn"><%# Eval("Plan_Other_Name")%>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><asp:Literal ID="Literal4" runat="server" Text='<%$ Resources:Resource, Label_States_Serviced %>' /></td>
