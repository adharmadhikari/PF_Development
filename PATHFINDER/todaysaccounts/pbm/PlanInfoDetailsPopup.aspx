<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Popup.master" AutoEventWireup="true" CodeFile="PlanInfoDetailsPopup.aspx.cs" Inherits="todaysaccounts_pbm_PlanInfo" %>
...
<%-- Today's Accounts - PBM -  Plan Information Modal --%>
    ...
    <script type="text/javascript">
        ...
        {            
            ...
            {  
                ...
                initgrid = true;
                sender.get_masterTableView().rebind();//correct filters should be set so bind now
            }
        }
