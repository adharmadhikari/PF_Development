<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/TriSection.master" AutoEventWireup="true" EnableViewState="true" CodeFile="coveredlives.aspx.cs" Inherits="todaysaccounts_commercial_coveredlives_Section2" %>
<%@ Register src="~/todaysaccounts/controls/CoveredLivesCommercial.ascx" tagname="CoveredLives" tagprefix="pinso" %>
...
<%-- Today's Accounts - Commercial -  Covered Lives / Benefit Design--%>
