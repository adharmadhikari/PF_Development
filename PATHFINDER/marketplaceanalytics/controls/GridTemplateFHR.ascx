<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GridTemplateFHR.ascx.cs" Inherits="marketplaceanalytics_controls_GridTemplate" %>
    <asp:Panel runat="server" id="drillDownContainer" CssClass="drillDownContainer" Height="274px">
    <asp:GridView runat="server" ID="gridTemplate" OnPreRender="drillDownContainer_PreRender" OnRowDataBound="drillDownContainer_RowDataBound" GridLines="None"
        AutoGenerateColumns="False" HeaderStyle-CssClass="detailedHeader" DataKeyNames="Product_ID" CssClass="grid gv" RowStyle-CssClass="gvr" AlternatingRowStyle-BackColor="#eaf2ff">
        <Columns>             
