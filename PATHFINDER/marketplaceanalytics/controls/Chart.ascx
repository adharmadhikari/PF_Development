...
<%@ Register src="~/marketplaceanalytics/controls/ChartTemplate.ascx" tagname="Chart" tagprefix="pinso" %>
<%@ Register src="~/marketplaceanalytics/controls/GridTemplate.ascx" tagname="Grid" tagprefix="pinso" %>
<div id="chartLeft">
    <div id="chartLeft1">
        <div id="chart1" class="tileContainer" >
            <div class="tileContainerHeader" onclick="javascript:chartClicked(1);">
                <div class="title"><asp:Label ID="lbl1" runat="server" Text="National"></asp:Label></div>
                <div class="tools">
    ...
    <div id="chartLeft2">
        <div id="chart2" class="tileContainer" >
            <div class="tileContainerHeader" onclick="javascript:chartClicked(2);">
                <div class="title"><asp:Label ID="lbl2" runat="server" Text="Regional"></asp:Label></div>
                <div class="tools">
                    <img class="showHideBtn enlarge" alt="enlarge" title="enlarge" src="content/images/spacer.gif"
...
<div id="chartRight">
    <div id="chart3" class="tileContainer" >
        <div class="tileContainerHeader" onclick="javascript:chartClicked(3);">
            <div class="title"><asp:Label ID="lbl3" runat="server" Text="State"></asp:Label></div>
            <div class="tools">
                <img class="showHideBtn enlarge" alt="enlarge" title="enlarge" src="content/images/spacer.gif"
