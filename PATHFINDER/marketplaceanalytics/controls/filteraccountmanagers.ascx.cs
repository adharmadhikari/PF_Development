...
public partial class marketplaceanalytics_controls_filteraccountmanagers : System.Web.UI.UserControl
{
    public marketplaceanalytics_controls_filteraccountmanagers()
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IncludeAll)
        {
            ...
            itemAM.Value = DefaultValue;
            Territory_ID.Items.Add(itemAM);
        }
    }
