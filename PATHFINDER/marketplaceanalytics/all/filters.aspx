<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PartialPage.master" AutoEventWireup="true" CodeFile="filters.aspx.cs" Inherits="marketplaceanalytics_all_filters" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register src="~/marketplaceanalytics/controls/FiltersContainer.ascx" tagname="FiltersContainer" tagprefix="pinso" %>
<%@ Register src="~/marketplaceanalytics/controls/FiltersContainerScript.ascx" tagname="FiltersContainerScript" tagprefix="pinso" %>
