<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/TriStack.master" AutoEventWireup="true" CodeFile="comparison.aspx.cs" Inherits="marketplaceanalytics_all_comparison" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <pinso:ReportScript ID="comparisonReportScript" runat="server" DrillDownGridUrl="marketplaceanalytics/all/detailedgridcomparison.aspx" /> 
</asp:Content>
