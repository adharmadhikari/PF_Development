<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PartialPage.master" AutoEventWireup="true" CodeFile="detailedgridcomparison.aspx.cs" Inherits="marketplaceanalytics_all_detailedgridcomparison" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="partialPage" Runat="Server">
    <asp:GridView runat="server" OnDataBound="detailedGrid_DataBound" OnPreRender="detailedGrid_PreRender" GridLines="None"  ID="detailedGrid" CssClass="grid" HeaderStyle-CssClass="detailedHeader"
    AutoGenerateColumns="False" >
        <Columns>
            ...
            <asp:TemplateField HeaderText="Restrictions">
                <ItemTemplate>                                     
                    <asp:Label ID="lblPA" runat="server" Text='<%# CheckRestriction((object)DataBinder.Eval(Container.DataItem, "PA"), (object)DataBinder.Eval(Container.DataItem, "QL"), (object)DataBinder.Eval(Container.DataItem, "ST")) %>'/>
