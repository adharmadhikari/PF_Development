<%@ Page Title="" Language="C#" MasterPageFile="~/standardreports/MasterPages/filters.master" AutoEventWireup="true" CodeFile="tiercoveragecomparison_filters.aspx.cs" Inherits="standardreports_all_tiercoveragecomparison_filters" %>
...
<%--<%@ Register src="../controls/FilterTierAsOption.ascx" tagname="FilterAsOption" tagprefix="uc5" %>--%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="filtersContainer" Runat="Server">
    ...
    <%--<uc5:FilterAsOption ID="TierAsOption" runat="server" />--%>
