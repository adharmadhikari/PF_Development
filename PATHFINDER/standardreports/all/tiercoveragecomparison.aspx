<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Pyramid.master" AutoEventWireup="true" CodeFile="tiercoveragecomparison.aspx.cs" Inherits="standardreports_all_tiercoveragecomparison" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Tile3" Runat="Server">
    <div id="divtiercoverageChart" style="height:100%;margin-left: 5%;">
...
<asp:Content ID="Content7" ContentPlaceHolderID="Tile4Tools" Runat="Server">
  <%--<div id="StdReportPieChart" onclick="javascript:OpenTCPieChartViewer(null,null,500,400);"></div>--%>
</asp:Content>
