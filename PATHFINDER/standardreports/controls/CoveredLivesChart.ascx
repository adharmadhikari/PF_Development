<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CoveredLivesChart.ascx.cs" Inherits="standardreports_controls_CoveredLivesChart" %>
    ...
    BackColor="Transparent" RepeatDelay="0">
            ...
            <Series>
                <DCWC:Series ChartArea="series2" 
                    ...
                    Font="Arial, 12pt" FontColor="DarkBlue"  
                    Name="s" ShadowColor="Transparent" ShowInLegend="False" 
                    XValueIndexed="True" XValueType="String" >
                </DCWC:Series>
            </Series>
            <ChartAreas>
