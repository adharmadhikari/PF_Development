<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FDrilldownDataVA.ascx.cs" Inherits="standardreports_controls_FDrilldownDataVA" %>
...
<%--<pinso:FormularyUpdateDate runat="server" ID="formularyUpdateDate" />--%>
  ...
  <div id="FDDHeaderVA" class="tileContainerHeader" style="margin-top: 2px !important;">
                    <div class="title"><img src="content/images/arwDwnW.gif" id="arrowR" /><asp:Literal runat="server" ID="Literal4" Text='  VA' /></div>
                    <div class="pagination" style="float:right"></div>
                    <div class="clearAll"></div>
    </div>
    </div>
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridFVA" AllowSorting="true"   
        ...
        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="Plan_Name" PageSize="10" 
         AllowMultiColumnSorting="true" HeaderStyle-Wrap="true"  >
           <Columns>
              ...
              <telerik:GridHyperLinkColumn DataNavigateUrlFormatString='javascript:OpenNotesViewer({0},{1},{2},{3},"comments",null,null,200,200,"ctl00_Tile3_fdrilldowndataVA_gridFVA");' DataNavigateUrlFields="Plan_ID,Drug_ID,Formulary_ID,Segment_ID" UniqueName="Comments" DataTextFormatString='{0}' DataTextField ="Comments" ItemStyle-CssClass="commentsCell" HeaderText="&nbsp;" HeaderStyle-Width="3%" ></telerik:GridHyperLinkColumn>               
   ...
   <pinso:RadGridWrapper runat="server" ID="radGridWrapper" Target="gridFVA" PagingSelector="#FDDHeaderVA .pagination" RequiresFilter="true" AutoUpdate="true"  LoadingText="" />
