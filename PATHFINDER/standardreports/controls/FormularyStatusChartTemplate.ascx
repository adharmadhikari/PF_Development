<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FormularyStatusChartTemplate.ascx.cs" Inherits="standardreports_controls_FormularyStatusChartTemplate" %>
...
<DCWC:Chart ID="chart" runat="server" Height="400px" Width="800px" ImageStorageMode="UseHttpHandler" 
    ...
    <Series>
           ...
           <DCWC:Series Name="Series2" Font="Arial, 8pt" FontColor="DarkBlue"  
            CustomAttributes="DrawingStyle=Cylinder"/>
           <DCWC:Series Name="Series3" Font="Arial, 8pt" FontColor="DarkBlue"  
            CustomAttributes="DrawingStyle=Cylinder"/>
            <DCWC:Series Name="Series4" Font="Arial, 8pt" FontColor="DarkBlue"  
            CustomAttributes="DrawingStyle=Cylinder"  />
           <%-- <DCWC:Series Name="Series5" Font="Arial, 8pt" FontColor="DarkBlue"  
            CustomAttributes="DrawingStyle=Cylinder"  />--%>
    </Series>     
    <ChartAreas>
