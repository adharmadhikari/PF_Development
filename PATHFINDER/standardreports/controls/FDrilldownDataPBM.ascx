<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FDrilldownDataPBM.ascx.cs" Inherits="standardreports_controls_FDrilldownDataPBM" %>
...
<%--<pinso:FormularyUpdateDate runat="server" ID="formularyUpdateDate" />--%>
  ...
  <div id="FDDHeaderPBM" class="tileContainerHeader" style="margin-top: 2px !important;">
                    <div class="title"><img src="content/images/arwDwnW.gif" id="arrowR" /><asp:Literal runat="server" ID="Literal4" Text='  PBM' /></div>
                    <div class="pagination" style="float:right"></div>
                    <div class="clearAll"></div>
    </div>
  </div>
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridFPBM" AllowSorting="true"   
        ...
        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="Plan_Name" PageSize="10" 
         AllowMultiColumnSorting="true" HeaderStyle-Wrap="true"  >
            <Columns>
                 <telerik:GridBoundColumn DataField="Geography_Name" HeaderText="Headquarters" HeaderStyle-Width="10%" 
   ...
   <pinso:RadGridWrapper runat="server" ID="radGridWrapper" Target="gridFPBM" PagingSelector="#FDDHeaderPBM .pagination" RequiresFilter="true" AutoUpdate="true"  LoadingText="" />
