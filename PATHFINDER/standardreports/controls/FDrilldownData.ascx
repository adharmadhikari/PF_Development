<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FDrilldownData.ascx.cs" Inherits="standardreports_controls_FDrilldownData" %>
...
<%--<pinso:FormularyUpdateDate runat="server" ID="formularyUpdateDate" />--%>
    ...
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridF" AllowSorting="true"   
        ...
        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="Plan_Name" PageSize="50" 
         AllowMultiColumnSorting="true" HeaderStyle-Wrap="true"  >
            <Columns>
                 <telerik:GridBoundColumn DataField="Geography_Name" HeaderText="Geography" HeaderStyle-Width="9%" 
                 ...
                 <telerik:GridBoundColumn DataField="PBM_Name" HeaderText="PBM" HeaderStyle-Width="8%" 
                           SortExpression="PBM_Name" ItemStyle-Wrap="true" HeaderStyle-Wrap="true"   UniqueName="PBM_Name" DataType="System.String" /> 
                 <telerik:GridBoundColumn DataField="Section_Name" HeaderText="Section Name" HeaderStyle-Width="10%" 
                           SortExpression="Section_Name"    UniqueName="Section_Name" DataType="System.String"></telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="FDD_Pharmacy_Lives" DataFormatString="{0:n0}" ItemStyle-CssClass="alignRight pharmacyLives"
                    DataType="System.Int32" HeaderText="Pharmacy Lives" HeaderStyle-Width="7%"
                    SortExpression="FDD_Pharmacy_Lives" UniqueName="FDD_Pharmacy_Lives"></telerik:GridBoundColumn>
                 ...
                 <telerik:GridBoundColumn DataField="Drug_Name" HeaderText="Drug"  ItemStyle-CssClass="notmerged drugName" 
                       UniqueName="Drug_Name" DataType="System.String" HeaderStyle-Width="7%"></telerik:GridBoundColumn>
              ...
              <telerik:GridHyperLinkColumn DataNavigateUrlFormatString='javascript:OpenNotesViewer({0},{1},{2},{3},"comments",null,null,200,200);' DataNavigateUrlFields="Plan_ID,Drug_ID,Formulary_ID,Segment_ID" UniqueName="Comments" DataTextFormatString='{0}' DataTextField ="Comments" ItemStyle-CssClass="commentsCell" HeaderText="&nbsp;" HeaderStyle-Width="2%" ></telerik:GridHyperLinkColumn>               
   ...
   <pinso:RadGridWrapper runat="server" ID="radGridWrapper" Target="gridF" PagingSelector="#divTile3Container .pagination" RequiresFilter="true" AutoUpdate="true"/>
