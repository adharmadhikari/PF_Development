...
public partial class standardreports_controls_FilterGeography : UserControl, IFilterControl
{
    public standardreports_controls_FilterGeography()
    {
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        string frag = "var regCtrl =$get('" + Geography_ID.ClientID + "');if(!regCtrl || !regCtrl.control) return;if (gt && gt == '1'){$loadListItems(l,null,{value:'" + DefaultValue + "',text:'" + DefaultValue + "'});l.control.set_visible(false);regCtrl.control.set_visible(false);loadranktypefilter(1);}if (gt && gt == '2'){$loadListItems(l, clientManager.get_RegionListOptions());l.control.set_visible(true);regCtrl.control.set_visible(true);loadranktypefilter(2);}if (gt && gt == '3'){$loadListItems(l, clientManager.get_States());l.control.set_visible(true);regCtrl.control.set_visible(true);loadranktypefilter(3);}if (gt && gt == '4'){$loadListItems(l, accountmanagerterritories);l.control.set_visible(true);regCtrl.control.set_visible(true);loadranktypefilter(4);}";
