<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FDrilldownDataSM.ascx.cs" Inherits="standardreports_controls_FDrilldownDataSM" %>
...
<%--<pinso:FormularyUpdateDate runat="server" ID="formularyUpdateDate" />--%>
  ...
  <div id="FDDHeaderSM" class="tileContainerHeader" style="margin-top: 2px !important;">
                    <div class="title"><img src="content/images/arwDwnW.gif" id="arrowR" /><asp:Literal runat="server" ID="Literal4" Text='  State Medicaid' /></div>
                    <div class="pagination" style="float:right"></div>
                    <div class="clearAll"></div>
    </div>
    </div>
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridFSM" AllowSorting="true"   
         ...
         AllowMultiColumnSorting="true" HeaderStyle-Wrap="true"  >
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Medicaid_Lives" DataFormatString="{0:n0}" ItemStyle-CssClass="alignRight medicaidLives"
                    DataType="System.Int32" HeaderText="Managed Medicaid Lives" HeaderStyle-Width="7%" ItemStyle-Width="7%"
                 ...
                 <telerik:GridBoundColumn DataField="Formulary_Lives" DataFormatString="{0:n0}" ItemStyle-CssClass="alignRight notmerged formularyLives"
                     DataType="System.Int32" HeaderText="Fee-For-Service Lives" HeaderStyle-Width="7%"
              ...
              <telerik:GridHyperLinkColumn DataNavigateUrlFormatString='javascript:OpenNotesViewer({0},{1},{2},{3},"comments",null,null,200,200,"ctl00_Tile3_fdrilldowndataSM_gridFSM");' DataNavigateUrlFields="Plan_ID,Drug_ID,Formulary_ID,Segment_ID" UniqueName="Comments" DataTextFormatString='{0}' DataTextField ="Comments" ItemStyle-CssClass="commentsCell" HeaderText="&nbsp;" HeaderStyle-Width="3%" ></telerik:GridHyperLinkColumn>               
   ...
   <pinso:RadGridWrapper runat="server" ID="radGridWrapper" Target="gridFSM" PagingSelector="#FDDHeaderSM .pagination" RequiresFilter="true" AutoUpdate="true"  LoadingText="" />
