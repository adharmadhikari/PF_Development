<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FDrilldownDataMM.ascx.cs" Inherits="standardreports_controls_FDrilldownDataMM" %>
...
<%--<pinso:FormularyUpdateDate runat="server" ID="formularyUpdateDate" />--%>
 <div ID="BDHeader1" class="areaHeader" runat="server"> 
    <div id="FDDHeaderMM" class="tileContainerHeader" style="margin-top: 2px !important;">
                    <div class="title"><img src="content/images/arwDwnW.gif" id="arrowR" /><asp:Literal runat="server" ID="Literal4" Text='  Managed Medicaid' /></div>
                    <div class="pagination" style="float:right"></div>
                    <div class="clearAll"></div>
    </div>
  </div> 
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridFMM" AllowSorting="true"   
        PageSize="10" AllowPaging="true" AllowFilteringByColumn="false" EnableEmbeddedSkins="false" on>
   ...
   <pinso:RadGridWrapper runat="server" ID="radGridWrapper" Target="gridFMM" PagingSelector="#FDDHeaderMM .pagination" RequiresFilter="true" AutoUpdate="true"  LoadingText="" />
