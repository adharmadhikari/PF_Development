...
<telerik:RadGrid SkinID="radTable" runat="server" ID="gridformularystatus" AllowSorting="false" AutoGenerateColumns="false"
     ...
     <MasterTableView AutoGenerateColumns="false" ClientDataKeyNames="Drug_ID,Drug_Name">
         <Columns>
            <telerik:GridBoundColumn DataField="Drug_Name"  HeaderStyle-Width="50px" HeaderText='Drug Name' SortExpression="Drug_Name" UniqueName="Drug_Name" /> 
            <telerik:GridBoundColumn DataField="Section_Name" HeaderText="Section" HeaderStyle-Width="65px" SortExpression="Section_Name" UniqueName="Section_Name" Display="False" />
