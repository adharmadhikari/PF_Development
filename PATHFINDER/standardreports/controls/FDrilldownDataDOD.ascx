<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FDrilldownDataDOD.ascx.cs" Inherits="standardreports_controls_FDrilldownDataDOD" %>
...
<%--<pinso:FormularyUpdateDate runat="server" ID="formularyUpdateDate" />--%>
  ...
  <div id="FDDHeaderDOD" class="tileContainerHeader" style="margin-top: 2px !important;">
                    <div class="title"><img src="content/images/arwDwnW.gif" id="arrowR" /><asp:Literal runat="server" ID="Literal4" Text='  DoD' /></div>
                    <div class="pagination" style="float:right"></div>
                    <div class="clearAll"></div>
    </div>
    </div>
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridFDOD" AllowSorting="true"   
 ...
 <telerik:GridBoundColumn DataField="Geography_Name" HeaderText="Geography" HeaderStyle-Width="10%" 
              ...
              <telerik:GridHyperLinkColumn DataNavigateUrlFormatString='javascript:OpenNotesViewer({0},{1},{2},{3},"comments",null,null,200,200,"ctl00_Tile3_fdrilldowndataDOD_gridFDOD");' DataNavigateUrlFields="Plan_ID,Drug_ID,Formulary_ID,Segment_ID" UniqueName="Comments" DataTextFormatString='{0}' DataTextField ="Comments" ItemStyle-CssClass="commentsCell" HeaderText="&nbsp;" HeaderStyle-Width="3%" ></telerik:GridHyperLinkColumn>               
   ...
   <pinso:RadGridWrapper runat="server" ID="radGridWrapper" Target="gridFDOD" PagingSelector="#FDDHeaderDOD .pagination" RequiresFilter="true" AutoUpdate="true"  LoadingText="" />
