...
Pathfinder.UI.PlanInfoGridWrapper.prototype =
{
    ...
    _onRowSelected: function(sender, args)
    {
        ...
        if (mergedRowCount > 1 && (cm.get_Channel().length > 1 || $.inArray(0, cm.get_Channel()) > -1))
        {
            ...
            if (cm.get_Channel()[0] > 100 || (cm.get_Channel()[0] == 0 && $.isArray(data["Original_Section"]) && data["Original_Section"].length == 1))
...
//                data["Plan_State"] = dataItem.Plan_State;
        ...
        var region = cm.get_Region();
        if (cm.get_EffectiveChannel() == 1 || cm.get_EffectiveChannel() == 99 || cm.get_EffectiveChannel() == 4 || cm.get_EffectiveChannel() == 6 || cm.get_EffectiveChannel() == 11 || cm.get_EffectiveChannel() == 12 || cm.get_EffectiveChannel() == 17)
        {
