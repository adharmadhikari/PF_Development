...
<%@ Register src="~/custom/labopharm/sellsheets/controls/ReviewPlanSelectionScript.ascx" tagname="ReviewPlanSelectionScript" tagprefix="labopharm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <labopharm:ReviewPlanSelectionScript ID="ReviewPlanSelectionScript1" runat="server" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="StepBody" Runat="Server">
   ...
   <%--Currently, maximum allowed limit for plan selection is 10, for that reason the GroupItemCount is set to "10"
