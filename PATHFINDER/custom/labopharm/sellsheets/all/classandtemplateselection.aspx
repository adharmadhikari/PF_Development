...
<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function classTemplateSelection_pageLoaded(sender, args)
        {
            ...
            //Create Drug list
            $createCheckboxDropdown(drugCtrlID, "Drug_ID", null, { 'maxItems': 3, 'defaultText': '--No Selection--', 'multiItemText': '<%= Resources.Resource.Label_Multiple_Selection %>' }, { 'error': classTemplateSelection_onDrugListError }, null);
            ...
            var drugListOptions = { 0: [] };

            //Select Labopharm's Market Basket(TheraID: 78 for "Therapeutic Class – MDD") by default.
            thera_id.selectItem(78);

            //Select Oleptro  (DrugID: 3631) as default drug.
            drugListOptions[0].ID = 3631;
            drugListOptions[0].Name = 'Oleptro';

            //Update hidden field with default theraid.
            $("#<%= txtTheraID.ClientID %>").val('78');
            ...
            {
                //Select Oleptro  (DrugID: 3631) as default drug.
                drug_id.selectItem(3631);
                //Update hidden field with default drugid and theraid.
                $("#<%= txtDrugID.ClientID %>").val('3631|78');
            }
        ...
        {
            //*******This code was commented since there was only one Thera Class for Labopharm's Market Basket(TheraID: 78 for "Therapeutic Class – MDD")*****************
            //*******Uncomment this code if multiple entries are added to Thera Class dropdown for Labopharm********************************************************************
...
<asp:Content ID="Content2" ContentPlaceHolderID="StepBody" Runat="Server">
    ...
    <tr>
        ...
        <td style="display: none;">
            <telerik:RadComboBox ID="rdcmbTheraClass" runat="server" EnableEmbeddedSkins="false" Skin="pathfinder" OnClientDropDownClosed="rdcmbTheraClass_DropDownClosed" DropDownWidth="300px" MaxHeight="250px" style="display: none;">
            </telerik:RadComboBox>
