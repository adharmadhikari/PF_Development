...
public partial class custom_labopharm_sellsheets_all_GenerateSellSheetPDF : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (PathfinderClientEntities context = new PathfinderClientEntities(Pinsonault.Web.Session.ClientConnectionString))
        {
            ...
            if (!string.IsNullOrEmpty(templateName))
            {
                ...
                footertemplateName = Server.MapPath("../templates/Sellsheet1_portraitfooter.jpg");
            }
        }
        ...
        s.ExportToPDFwithFooter(url, strCookieName, strCookieValue, sFileName, templateName, true, footertemplateName);
    }    
}
