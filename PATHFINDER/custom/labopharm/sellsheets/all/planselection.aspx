...
<%@ Register src="~/custom/labopharm/sellsheets/controls/PlanSelectionScript.ascx" tagname="PlanSelectionScript" tagprefix="labopharm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <labopharm:PlanSelectionScript runat="server" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="StepBody" Runat="Server">
  <div>
  <%--Maximum allowed limit for plan selection is 12--%>
   <asp:Label ID="msglbl" runat="server" Visible="false" Text="Please select between 1 and 12 plans" style="color:Red;"></asp:Label>
   <br />
   <div class="AddAcct"><span class="ssBold"><a id="AddAcctLnk" href="javascript:OpenAddAccount();">Add an Account</a></span></div> 
    ...
    <pinso:ClientValidator ID="vldPlansSelected" Required ="true" Target="hdnPlansSelected" Text="Please select between 1 and 12 plans" runat="server" />  
