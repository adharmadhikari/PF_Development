...
public partial class custom_controls_SSPreviewControl1 : System.Web.UI.UserControl
{
    ...
    protected void ReviewPlanListView_OnItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        //HTML code contains "OLEPTRO&#153;" in Header2 for inserting TradeMake(TM) symbol. 
        //For other drugs just put drugname without TM symbol in the header.
        if(lstDrugs[0].ToUpper().Trim() != "OLEPTRO")
            Header2.InnerText = lstDrugs[0].ToUpper();
        ...
        Header3.InnerText = lstDrugs[1].ToUpper();
        ...
        Header4.InnerText = lstDrugs[2].ToUpper();
