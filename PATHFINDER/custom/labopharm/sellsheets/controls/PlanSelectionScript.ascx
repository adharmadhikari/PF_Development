...
<script type="text/javascript">
    ...
    function PlanSelectionChanged(sender, PlanID, FormularyID, ProductID)
    {
        ...
        //If checkbox is checked and the array length is less than 12 then add the selected PlanID to the list
        //Please note that the current plan selection allows maximum of 12 selected plans.
        if (sender.checked)
        {
            ...
            else
            {
                ...
                //Maximum allowed limit for plan selection is 12.
                $alert("A maximum of 12 plans can be selected.", "Plan Selection");
            }
        }
        else
        {
