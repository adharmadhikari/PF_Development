<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SingleSection.master" AutoEventWireup="true" CodeFile="planinformation.aspx.cs" Inherits="custom_millennium_todaysaccounts_rtarecords_planinformation" %>
<%@ Register src="~/custom/millennium/todaysaccounts/controls/PlanInfoDetailsRTA.ascx" tagname="PlanInfoDetails" tagprefix="pinso" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Tile3Tools" Runat="Server">
 <table><tr> 
    ...
    <td><pinso:TileOptionsMenu runat="server" ID="TileOptionsMenu1" /></td>
    <td>
        <a id="Edit" href="javascript:OpenRTAPlanInfo('EditPlan','')">Edit</a>
    </td>
    </tr></table>
</asp:Content>
