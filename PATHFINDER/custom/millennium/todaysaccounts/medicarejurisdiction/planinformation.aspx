<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SingleSection.master" AutoEventWireup="true" CodeFile="planinformation.aspx.cs" Inherits="custom_millennium_todaysaccounts_medicarejurisdiction_planinformation" %>
<%@ Register src="~/custom/millennium/todaysaccounts/controls/PlanInfoDetailsMJ.ascx" tagname="PlanInfoDetails" tagprefix="pinso" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Tile3Tools" Runat="Server">
  <table><tr> 
    ...
    <td><a id="Edit" href="javascript:OpenMJPlanInfo('EditPlan','')">Edit</a></td>
    </tr></table>
</asp:Content>
