    ...
    protected void ProcessRequest(string BtnClicked)
    {
        ...
        using (PathfinderMillenniumEntities context = new PathfinderMillenniumEntities())
        {
            ...
            if (Plan_ID != 0)
            {
                ...
                customplan.Email = ((System.Web.UI.WebControls.TextBox)(this.formViewPlanInfo.FindControl("TxtEmail"))).Text;
                if (!string.IsNullOrEmpty(((Telerik.Web.UI.RadComboBox)(this.formViewPlanInfo.FindControl("rcb_va"))).SelectedValue))
                    customplan.VA_VISN = (((Telerik.Web.UI.RadComboBox)(this.formViewPlanInfo.FindControl("rcb_va"))).SelectedValue);
                else
                    customplan.VA_VISN = null;
