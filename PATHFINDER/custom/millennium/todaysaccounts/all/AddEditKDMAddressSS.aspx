<%@ Page Language="C#" MasterPageFile="~/MasterPages/Modal.master"  AutoEventWireup="true" CodeFile="AddEditKDMAddressSS.aspx.cs" Inherits="custom_millennium_todaysaccounts_all_AddEditKDMAddressSS" %>
                    ...
                    <table>
                        ...
                        <tr> 
                            <td><label for="Ziptxt">Zip *</label>
                                <asp:TextBox ID="Ziptxt" TabIndex="5" MaxLength="5" runat="server" Width="111px" Text='<%# Bind("KDM_Zip") %>'></asp:TextBox>
                            </td>
                        </tr> 
                        <tr> 
                            <td><label for="Zip4txt">Zip + 4</label>
                                <asp:TextBox ID="Zip4txt" TabIndex="6"  MaxLength="4" runat="server" Width="111px" Text='<%# Bind("KDM_Zip_4") %>'></asp:TextBox>
                            </td>
                        </tr> 
        ...
        <EditItemTemplate>
            ...
            <tr>
                <td valign="top">
                    ...
                    <tr align="left">
                        <td><label for="Address1txt">Address 1 *</label>
                            <asp:TextBox TabIndex="1" ID="Address1txt" MaxLength="150" runat="server" Width="331px" Text='<%# Bind("KDM_Address1") %>'></asp:TextBox>
                        </td>
                    </tr>
                    <tr>    
                        <td><label for="Address2txt">Address 2</label>
                            <asp:TextBox TabIndex="2" ID="Address2txt" MaxLength="150" runat="server" Width="331px" Text='<%# Bind("KDM_Address2") %>'></asp:TextBox>
                        
                        </td>
                    </tr>
                    <tr>
                        <td><label for="Citytxt">City</label>
                            <asp:TextBox TabIndex="3" ID="Citytxt" MaxLength="100" runat="server" Width="237px" Text='<%# Bind("KDM_City") %>'></asp:TextBox>
                        </td>
                    </tr>              
                    </table>
                </td>
        ...
        <ItemTemplate>
            ...
            <tr>
                <td valign="top">
                    ...
                    <tr>    
                        <td><label for="Address2txt">Address 2</label>
                            <asp:TextBox TabIndex="2" ID="Address2txt" runat="server" Width="331px" Text='<%# Bind("KDM_Address2") %>'></asp:TextBox>
