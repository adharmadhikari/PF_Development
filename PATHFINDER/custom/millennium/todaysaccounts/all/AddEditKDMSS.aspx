<%@ Page Language="C#"  MasterPageFile="~/MasterPages/Modal.master"  AutoEventWireup="true" CodeFile="AddEditKDMSS.aspx.cs" Inherits="custom_millennium_todaysaccounts_all_AddEditKDMSS" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="Server">
                    ...
                    <table>
                         <tr>                        
                            <td><label for="Phtxt">Phone</label>
                              <asp:TextBox TabIndex="5" ID="Phtxt" runat="server" Width="111px" Text='<%# Bind("KDM_Phone") %>'></asp:TextBox>
                             </td>
                        </tr>
                        <tr> 
                            <td><label for="Faxtxt">Fax</label>
                                <asp:TextBox ID="Faxtxt" TabIndex="6" runat="server" Width="111px" Text='<%# Bind("KDM_Fax") %>'></asp:TextBox>
                            </td>
                        </tr> 
                        <%--<tr>
                            <td>
                                ...
                                <telerik:RadComboBox ID="rdlCredentials" runat="server" AppendDataBoundItems="true" DataSourceID="dsCustomCredentials"
                                        TabIndex="6" Skin="pathfinder" Width="343px" DropDownWidth="343px"  DataTextField ="Credentials_Name"
            ...
            <tr>
                ...
                <td valign="top">
                    <table>
                         <tr>                        
                            <td><label for="Phtxt">Phone</label>
                              <asp:TextBox TabIndex="5" ID="Phtxt" runat="server" Width="111px" Text='<%# Eval("KDM_Phone") %>' ReadOnly="true"></asp:TextBox>
                             </td>
                        </tr>
                        <tr> 
                            <td><label for="Faxtxt">Fax</label>
                                <asp:TextBox ID="Faxtxt" TabIndex="6" runat="server" Width="111px" Text='<%# Eval("KDM_Fax") %>' ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                        <%--<tr>
                            <td>
    ...
    <asp:EntityDataSource runat="server" ID="dsCustomsTitle" ConnectionString="name=PathfinderMillenniumEntities" DefaultContainerName="PathfinderMillenniumEntities" 
       EnableInsert="true" EntitySetName="CustomTitleSet" Where="it.Section_ID=106" OrderBy="it.Title_Name">     
    </asp:EntityDataSource>  
    <asp:EntityDataSource runat="server" ID="dsCustomCredentials" ConnectionString="name=PathfinderMillenniumEntities" DefaultContainerName="PathfinderMillenniumEntities" 
       AutoGenerateWhereClause="true" EnableInsert="true" EntitySetName="CustomCredentialsSet" OrderBy="it.Credentials_Name">     
    </asp:EntityDataSource>  
    <div>
