<%@ Page Language="C#"   MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="AddEditKDMAddressRTA.aspx.cs" Inherits="custom_millennium_todaysaccounts_all_AddEditKDMAddressRTA" %>
                    ...
                    <table>
                        ...
                        <tr> 
                            <td><label for="Ziptxt">Zip *</label>
                                <asp:TextBox ID="Ziptxt" TabIndex="5" runat="server" Width="111px" MaxLength="5" Text='<%# Bind("KDM_Zip") %>'></asp:TextBox>
                            </td>
                        </tr> 
                        <tr> 
                            <td><label for="Zip4txt">Zip + 4</label>
                                <asp:TextBox ID="Zip4txt" TabIndex="6" runat="server" Width="111px" MaxLength="4" Text='<%# Bind("KDM_Zip_4") %>'></asp:TextBox>
                            </td>
                        </tr> 
