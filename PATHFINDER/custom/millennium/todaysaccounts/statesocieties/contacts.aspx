<%@ Page  EnableViewStateMac="false"  Title="" Theme="pathfinder" Language="C#" MasterPageFile="~/MasterPages/SingleSection.master" AutoEventWireup="true" CodeFile="contacts.aspx.cs" Inherits="custom_millennium_todaysaccounts_statesocieties_contacts" %>
<%@ Register src="~/custom/millennium/todaysaccounts/controls/KDMDetailsSS.ascx" tagname="KDMDetailsSS" tagprefix="pinso" %>
<%@ Register src="~/custom/millennium/todaysaccounts/controls/KDMAddressSS.ascx" tagname="KDMAddressSS" tagprefix="pinso" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Tile3" Runat="Server">
    <pinso:KDMDetailsSS ID="KDMDetailsSS1" runat="server" />
    <pinso:KDMAddressSS ID="KDMAddressSS1" runat="server" />
</asp:Content>
