<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PlanInfoDetailsRTA.ascx.cs" Inherits="custom_millennium_todaysaccounts_controls_PlanInfoDetails" %>
 <div id="lfView">
        ...
        <ItemTemplate>
            <table style="vertical-align: top;" class="genTable" cellpadding="0" cellspacing="0"
                border="0">
                 <tr>
                    <td>
                        <asp:Literal ID="Literal14" runat="server" Text="RAM" />
                    </td>
                    <td class="rn">
                        <%# Eval("User_Name")%>&nbsp;
                    </td>
              ...
              <tr>
                    <td>
                        <asp:Literal ID="Literal1" runat="server" Text="RTA Organization Name" />
                    </td>
                    <td class="rn">
                        <%# Eval("Plan_Name")%>&nbsp;
                    </td>
...
<tr>
                ...
                <tr>
                    <td>
                        <asp:Literal ID="Literal12" runat="server" Text="Fax" />
                    </td>
                    <td class="rn">
                        <%# Eval("Fax")%>&nbsp;
                    </td>
...
<tr>
                    <td>
                        <asp:Literal ID="Literal5" runat="server" Text="Primary Network" />
                    </td>
                    <td class="rn">
                        <%# Eval("Primary_Network_Name")%>&nbsp;
                    </td>
                </tr>
                <tr>
                    <td>
