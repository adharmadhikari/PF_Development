<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KDMAddressRTA.ascx.cs" Inherits="custom_millennium_todaysaccounts_controls_KDMAddressRTA" %>
<div id="gap" style="width: 100%; height:20px;border-bottom:1px solid #CCC;"></div>
 <div class="tools">
        <span id="AddAddressButton"><a id="AddKDM" href="javascript:OpenKDMAddress('AddKDM','','RTA');">Add </a></span>   
        <span id="EditDeleteAddressButtons"> | <a id="EditKDM" href="javascript:OpenKDMAddress('EditKDM','','RTA');">Edit </a> |
        <a id="DeleteKDM" href="javascript:OpenKDMAddress('DelKDM','','RTA');">Delete </a></span>        
     </div> 
