<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KDMAddressSS.ascx.cs" Inherits="custom_millennium_todaysaccounts_controls_KDMAddressSS" %>
<div id="gap" style="width: 100%; height:20px;border-bottom:1px solid #CCC;"></div>
 <div class="tools">
        <span id="AddAddressButton"><a id="AddKDM" href="javascript:OpenKDMAddress('AddKDM','','SS');">Add </a></span>   
        <span id="EditDeleteAddressButtons"> | <a id="EditKDM" href="javascript:OpenKDMAddress('EditKDM','','SS');">Edit </a> |
        <a id="DeleteKDM" href="javascript:OpenKDMAddress('DelKDM','','SS');">Delete </a></span>        
     </div> 
