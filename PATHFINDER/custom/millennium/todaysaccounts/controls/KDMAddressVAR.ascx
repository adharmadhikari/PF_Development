<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KDMAddressVAR.ascx.cs" Inherits="custom_millennium_todaysaccounts_controls_KDMAddressVAR" %>
<div id="gap" style="width: 100%; height:20px;border-bottom:1px solid #CCC;"></div>
 <div class="tools">
        <span id="AddAddressButton"><a id="AddKDM" href="javascript:OpenKDMAddress('AddKDM','','VAR');">Add </a> </span> 
        <span id="EditDeleteAddressButtons"> | <a id="EditKDM" href="javascript:OpenKDMAddress('EditKDM','','VAR');">Edit </a> |
        <a id="DeleteKDM" href="javascript:OpenKDMAddress('DelKDM','','VAR');">Delete </a></span>        
     </div> 
...
<div id="kcView">
     ...
     <pinso:RadGridWrapper runat="server" ID="gridWrapper" Target="gridKDMAddress" OnClientDataBinding="RefreshKDMAddress" AutoUpdate="false"/>
</div> 
