<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SingleSection.master" AutoEventWireup="true" CodeFile="planinformation.aspx.cs" Inherits="custom_millennium_todaysaccounts_varecords_planinformation" %>
<%@ Register src="~/custom/millennium/todaysaccounts/controls/PlanInfoDetailsVAR.ascx" tagname="PlanInfoDetails" tagprefix="pinso" %>
...
<table>
    <tr> 
        ...
        <td> 
            <a id="Edit" href="javascript:OpenVARPlanInfo('EditPlan','')">Edit</a>
        </td>
    </tr>
</table>  
</asp:Content>
