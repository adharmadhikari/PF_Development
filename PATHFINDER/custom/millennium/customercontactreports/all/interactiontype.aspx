<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Pyramid.master" AutoEventWireup="true" CodeFile="interactiontype.aspx.cs" Inherits="custom_millennium_customercontactreports_all_meetingtype" %>
<%@ Register src="~/custom/millennium/customercontactreports/controls/ccrChart.ascx" tagname="ccrChart" tagprefix="pinso" %>
<%@ Register Src="~/custom/millennium/customercontactreports/controls/ccrMeetingTypeData.ascx" tagname="ccrMeetingTypeData" tagprefix="pinso"%>
<%@ Register Src="~/custom/millennium/customercontactreports/controls/ccrMeetingTypeDrillDown.ascx" tagname="ccrMeetingTypeDrillDown" tagprefix="pinso"%>
<%@ Register Src="~/custom/millennium/customercontactreports/controls/ccrMeetingTypeScript.ascx" tagname ="ccrMeetingTypeScript" TagPrefix="pinso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Tile3Title" Runat="Server">
    <asp:Literal runat="server" ID="lbl1" Text='Customer Contact Interaction Type' /> 
</asp:Content>
