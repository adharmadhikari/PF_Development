<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ccrMeetingActivityDataTemplate.ascx.cs" Inherits="custom_millennium_customercontactreports_controls_ccrMeetingActivityDataTemplate" %>
...
<telerik:RadGrid OnPreRender="gridCcrMeetingActivity_PreRender" SkinID="radTable" runat="server" ID="gridCcrMeetingActivity" AllowSorting="False"  AllowFilteringByColumn="false" AutoGenerateColumns="False"
 AllowPaging="True" EnableEmbeddedSkins="False" GridLines="None">
    <MasterTableView AutoGenerateColumns="false"  Width="100%" AllowSorting="false" ClientDataKeyNames="Meeting_Activity_ID, Products_Discussed_ID, Meeting_Activity_Name">   
         <Columns>
            ...
            <telerik:GridBoundColumn DataField="Meeting_Activity_Name" HeaderStyle-Width="47%" 
                HeaderText='Topic Name' UniqueName="Meeting_Activity_Name" />             
