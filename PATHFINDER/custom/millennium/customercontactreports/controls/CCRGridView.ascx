    ...
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCCReports" AllowSorting="True" EnableEmbeddedSkins="False" PageSize="50">        
        <MasterTableView autogeneratecolumns="false" ClientDataKeyNames="Contact_Report_ID, Plan_ID" AllowPaging="true" Width="100%" PageSize="50">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Meeting_Activity_Name" HeaderText="Meeting Topic" HeaderStyle-Width="25%" SortExpression="Meeting_Activity_Name" UniqueName="Meeting_Activity_Name"  DataType ="System.String"/>          
                <telerik:GridBoundColumn DataField="Meeting_Type_Name" HeaderText="Interaction Type" HeaderStyle-Width="25%" SortExpression="Meeting_Type_Name" UniqueName="Meeting_Type_Name" DataType = "System.String" />
        ...
        <ClientSettings ClientEvents-OnRowSelecting="gridCCReports_OnRowSelecting">
            <DataBinding Location="~/custom/millennium/customercontactreports/services/MillenniumDataService.svc" DataService-TableName="ContactReportProductsDiscussedViewSet" SelectCountMethod ="GetCCReportCount">
            </DataBinding>
