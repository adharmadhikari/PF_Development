     ...
     <telerik:RadGrid SkinID="radTable" runat="server" ID="gridPlans" AllowSorting="True" EnableEmbeddedSkins="False" PageSize="50" AllowFilteringByColumn="true">        
       ...
       <PagerStyle Visible="false" />
        ...
        <ClientSettings ClientEvents-OnRowSelected="gridPlans_OnRowSelected">
            <DataBinding Location="~/custom/millennium/customercontactreports/services/MillenniumDataService.svc" DataService-TableName="PlansGridSet" >
            </DataBinding>
            <Scrolling AllowScroll="true" UseStaticHeaders="true" /> 
            <Selecting AllowRowSelect="true" />
        </ClientSettings>   
    </telerik:RadGrid>    
     <pinso:RadGridWrapper runat="server" ID="gridWrapper" Target="gridPlans" MergeRows="false" PagingSelector="#tile8ContainerHeader .pagination"  RequiresFilter ="false" AutoLoad="false" AutoUpdate="false" />       
