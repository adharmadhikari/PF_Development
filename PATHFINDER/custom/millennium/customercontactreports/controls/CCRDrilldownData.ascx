<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCRDrilldownData.ascx.cs" Inherits="custom_controls_CCRDrilldownData" %>
  ...
  <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCR" AllowSorting="true"   
        ...
        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="Plan_Name, Geography_Name, Contact_Date, Meeting_Activity_Name, Meeting_Type_Name" PageSize="50"
         AllowMultiColumnSorting="true" Width="100%" >
            ...
            <telerik:GridBoundColumn DataField="Account_Manager" HeaderStyle-Width="11%" ItemStyle-CssClass="firstCol planName"
             ...
             <telerik:GridBoundColumn DataField="Meeting_Activity_Name" HeaderText="Meeting Topic" ItemStyle-CssClass="meetActivity"
                        UniqueName="Meeting_Activity_Name"  DataType ="System.String" HeaderStyle-Width="12%"/>   <%--Resources:Resource, Label_Meeting_Activity --%>
                               
             <telerik:GridBoundColumn DataField="Meeting_Type_Name" HeaderText="Interaction Type" ItemStyle-CssClass="meetType"
                        UniqueName="Meeting_Type_Name" DataType = "System.String" HeaderStyle-Width="12%"/> <%--Resources:Resource, Label_Meeting_Type--%>      
       ...
       <ClientSettings >
            <DataBinding Location="~/custom/millennium/customercontactreports/services/PathfinderDataService.svc" DataService-TableName="ContactReportDataSet" 
