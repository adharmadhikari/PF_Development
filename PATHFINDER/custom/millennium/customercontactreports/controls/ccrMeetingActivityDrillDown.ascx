<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ccrMeetingActivityDrillDown.ascx.cs" Inherits="custom_millennium_customercontactreports_controls_ccrMeetingActivityDrillDown" %>
         ...
         ClientDataKeyNames="Plan_ID">
             ...
             <Columns>
                ...
                <telerik:GridBoundColumn DataField="Meeting_Type_Name" HeaderStyle-Width="17%" 
                     HeaderText='Interaction Type' SortExpression="Meeting_Type_Name" 
...
<pinso:RadGridWrapper runat="server" ID="radGridWrapper" Target="gridCcrMeetingActivityDrillDown" MergeRows="false" PagingSelector="#divTile5Container .pagination" DrillDownLevel="1" AutoUpdate="true" RequiresFilter="true" UtcDateColumns="Contact_Date,Followup_Date" />
