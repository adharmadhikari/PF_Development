<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FilterContainerScript.ascx.cs" Inherits="custom_millennium_customercontactreports_controls_FilterContainerScript" %>
...
<%@ OutputCache Shared="true" VaryByParam="None" Duration="120" %>  
    ...
    <script type="text/javascript">
        ...
        function requestReport() {
            ...
            //Delete Section_ID filter if All section is selected.
            if (data["Section_ID"] && data["Section_ID"].value == 0)
