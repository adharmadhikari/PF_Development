<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChartTemplate.ascx.cs" Inherits="custom_warner_formularyhistoryreporting_controls_ChartTemplate" %>
<DCWC:Chart ID="chart" runat="server"   Height="400px" Width="800px"
 EnableTheming="True" ImageType="Flash" 
    ...
    <Series>
        <DCWC:Series ChartType="StackedColumn" Name="Series1" ShowInLegend="false" />
        <DCWC:Series ChartType="StackedColumn" Name="Series2" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series3" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series4" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series5" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series6" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series7" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series8" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series9" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series10" ShowInLegend="false"/>
        <DCWC:Series ChartType="StackedColumn" Name="Series11" ShowInLegend="false"/>
    </Series>     
    <ChartAreas>
