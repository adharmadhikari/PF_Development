...
<%@ Register Src="~/custom/pinso/customercontactreports/controls/CCRGridView.ascx" TagName="CCRGridList" TagPrefix="pinso" %>
<%@ Register Src="~/custom/pinso/customercontactreports/controls/BusinessPlansGrid.ascx" TagName="CCBusinessDocument" TagPrefix="pinso" %>
<%@ Register Src="~/custom/pinso/customercontactreports/controls/CCRPlanGridView.ascx" TagName="CCPlanGrid" TagPrefix="pinso" %>
<%@ Register Src="~/custom/pinso/customercontactreports/controls/CCReportScripts.ascx" TagName="CCPlanScript" TagPrefix="pinso" %>
