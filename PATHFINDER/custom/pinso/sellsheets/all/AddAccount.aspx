...
<table>
    ...
    <tr>
        ...
        <td>
             <telerik:RadComboBox ID="rdcmbPlans" runat="server" DropDownWidth="230px" Height="80px" EnableEmbeddedSkins="false" SkinID="planInfoCombo" Skin="pathfinder" AppendDataBoundItems="true" DataSourceID="dsPlans" DataTextField="Plan_Name" DataValueField="Plan_ID" OnSelectedIndexChanged="rdcmbPlans_SelectedIndexChanged" OnDataBound="rdcmbPlans_OnDataBound" Visible="true" >
            </telerik:RadComboBox>
        </td>
    </tr>
    <tr>
