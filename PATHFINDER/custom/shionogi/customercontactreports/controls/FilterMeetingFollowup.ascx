...
<telerik:RadComboBox ID="Followup_ID" runat="server" EnableEmbeddedSkins="false" Skin="pathfinder" DataSourceID="dsFollowup" DataTextField="Followup_Notes_Name" DataValueField="Followup_Notes_ID" AppendDataBoundItems="true">
<Items>
