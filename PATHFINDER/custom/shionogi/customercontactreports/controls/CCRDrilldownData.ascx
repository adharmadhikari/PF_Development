  ...
  <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCR" AllowSorting="true"   
        ...
        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="Plan_Name, Geography_Name, Contact_Date, Meeting_Activity_Name, Meeting_Type_Name" PageSize="50"
         AllowMultiColumnSorting="true" Width="100%" >
            <Columns>
             <telerik:GridBoundColumn DataField="Plan_Name" HeaderText="Account Name" ItemStyle-CssClass="firstCol planName"
                          UniqueName="Plan_Name" DataType="System.String" HeaderStyle-Width="20%" />                    
             
             <telerik:GridBoundColumn DataField="Geography_Name" HeaderText="Geography" ItemStyle-CssClass="geogName"
                          UniqueName="Geography_Name" DataType="System.String" HeaderStyle-Width="14%"></telerik:GridBoundColumn>
             ...
             <telerik:GridBoundColumn DataField="Contact_Date" HeaderText='<%$ Resources:Resource, Label_CR_Date %>' ItemStyle-CssClass="alignRight contactDT"
                         UniqueName="Contact_Date" DataType ="System.DateTime" DataFormatString="{0:M/dd/yyyy}" HeaderStyle-Width="10%"> </telerik:GridBoundColumn>         
               
             <telerik:GridBoundColumn DataField="Section_Name" HeaderText="Market Segment" ItemStyle-CssClass="sectName"
                        UniqueName="Section_Name" DataType="System.String" HeaderStyle-Width="14%" />
             ...
             <telerik:GridBoundColumn DataField="Meeting_Activity_Name" HeaderText='<%$ Resources:Resource, Label_Meeting_Activity %>' ItemStyle-CssClass="meetActivity"
                        UniqueName="Meeting_Activity_Name"  DataType ="System.String" HeaderStyle-Width="14%"/>  
             ...
             <telerik:GridBoundColumn DataField="Meeting_Type_Name" HeaderText='<%$ Resources:Resource, Label_Meeting_Type %>' ItemStyle-CssClass="meetType"
                        UniqueName="Meeting_Type_Name" DataType = "System.String" HeaderStyle-Width="14%"/>       
             ...
             <telerik:GridBoundColumn DataField="Drug_Name" HeaderText="Drug" HeaderStyle-Width="14%" ItemStyle-CssClass="notmerged drugName" 
