...
<pinso:ClientValidator runat="server" id="validator1" target="Products_Discussed_ID" DataField="Products_Discussed_ID" Required="true" Text='<%$ Resources:Resource, Message_Required_DrugSelection %>' />
