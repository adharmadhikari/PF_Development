...
<%@ Register src="../controls/ccrProductsDiscussedData.ascx" tagname="ccrProductsDiscussedData" tagprefix="pinso" %>
<%@ Register src="../controls/ccrProductsDiscussedDrillDown.ascx" tagname="ccrProductsDiscussedDrillDown" tagprefix="pinso" %>
<%@ Register src="../controls/ccrProductsDiscussedScript.ascx" tagname="ccrProductsDiscussedScript" tagprefix="pinso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Tile3Title" Runat="Server">
    <asp:Literal runat="server" ID="lbl1" Text='Products Discussed' /> 
</asp:Content>
