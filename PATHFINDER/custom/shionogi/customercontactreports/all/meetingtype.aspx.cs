    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using ( PathfinderClientModel.PathfinderClientEntities clientContext = new PathfinderClientModel.PathfinderClientEntities(Pinsonault.Web.Session.ClientConnectionString) )
        {
            ...
            if (productId.Count() >= 1)
            {
                ...
                meetingTypeFilterProd1 = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingTypeFilterProd1National = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
            ...
            if (productId.Count() >= 2)
            {
                ...
                meetingTypeFilterProd2 = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingTypeFilterProd2National = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
            ...
            if (productId.Count() == 3)
            {
                ...
                meetingTypeFilterProd3 = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingTypeFilterProd3National = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
