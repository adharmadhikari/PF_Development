        ...
        using ( PathfinderClientEntities context = new PathfinderClientEntities(Pinsonault.Web.Session.ClientConnectionString) )
            {
                ...
                ccrView.Meeting_Outcome_Other = (formViewCCR.FindControl("txtMeetingOutcomeOther") as TextBox).Text;
                ccrView.Followup_Notes_Other = (formViewCCR.FindControl("txtFollowupNotesOther") as TextBox).Text;
