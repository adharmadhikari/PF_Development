...
<%@ Register src="../controls/AddEditCCRScript.ascx" tagname="CCRScript" tagprefix="pinso" %>
...
function onMeetingActivityChanged(sender, args)
{
    disableOtherText("ctl00_main_formViewCCR_txtMeetingActivityOther", sender.get_value() != 100);
}

function onMeetingTypeChanged(sender, args)
{
    disableOtherText("ctl00_main_formViewCCR_txtMeetingTypeOther", sender.get_value() != 100);
}
...
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="Server">
    ...
    <asp:FormView runat="server" ID="formViewCCR" CellPadding="0" Width="100%" DataSourceID="dsContactReport">
        <ItemTemplate>
                ...
                <tr>
                        ...
                        <table align="left" >
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    ...
                                    <pinso:MaxLengthValidator ID="MaxLengthValidator12" runat="server" ControlToValidate="txtMeetingTypeOther" ErrorMessage="Meeting Type notes must be less than 150 characters." MaxLength="150" Display="None" />
                                </td>
                            </tr>                             
                            <tr align="left">
                           ...
                           <tr align="left">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtMeetingOutcomeOther" Text='<%# Eval("Meeting_Outcome_Other") %>' CssClass="meetingOutcomeOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator ID="MaxLengthValidator22" runat="server" ControlToValidate="txtMeetingOutcomeOther" ErrorMessage="Meeting Outcome notes must be less than 150 characters." MaxLength="150" Display="None" />
                                </td>
                            </tr>                                
                            <tr align="left">
                                <td width="130px">                                    
                    ...
                    <td valign="top">
                        <table cellpadding="2" cellspacing="2" >
                            ...
                            <tr align="left">
                                ...
                                <td>
                                    <telerik:RadComboBox runat="server" ID="rdlMeetingActivity" DataSourceID="dsMeetingActivity"
                                        ...
                                        OnClientLoad="onMeetingActivityChanged"
                                        OnClientSelectedIndexChanged="onMeetingActivityChanged"
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtMeetingActivityOther" Text='<%# Eval("Meeting_Activity_Other") %>' CssClass="meetingActivityOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator ID="MaxLengthValidator32" runat="server" ControlToValidate="txtMeetingActivityOther" ErrorMessage="Meeting Activity notes must be less than 150 characters." MaxLength="150" Display="None" />
                                </td>
                            </tr>                                
                            <tr align="left">
                                <td colspan="2">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtFollowupNotesOther" Text='<%# Eval("Followup_Notes_Other") %>' CssClass="followupNotesOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator ID="MaxLengthValidator1" runat="server" MaxLength="150" ControlToValidate="txtFollowupNotesOther" ErrorMessage="Followup Notes must be less than 150 characters." Display="None" />
                                </td>
                            </tr>                                                                                          
                        </table>
                    </td>                  
            ...
            <ajax:MaskedEditValidator runat="server" ID="MaskedEditValidator1" ControlExtender="MaskedEditExtender1" ControlToValidate="rdCCRDate" InvalidValueMessage="Please enter a valid date format (xx/xx/xxx)" /> 
            <ajax:MaskedEditValidator runat="server" ID="MaskedEditValidator2" ControlExtender="MaskedEditExtender2" ControlToValidate="rdFollowUpDate" InvalidValueMessage="Please enter a valid date format (xx/xx/xxx)" /> 
            ...
            <div class="modalFormButtons">
                <span class="coreBtn">
                    <span class="bg">
                        <span class="bg2">
                            <asp:Button TabIndex="9" ID="btnEdit" runat="server" Text="Update" Visible="true" OnClick="Editbtn_Click" />
                        </span>
                    </span>
                </span>
                <span class="coreBtn">
                    <span class="bg">
                        <span class="bg2">
                            <asp:Button ID="btnReset" TabIndex="10" runat="server" Text="Reset" OnClientClick="javascript:ClearForm(); return false;" />
                        </span>
                    </span>
                </span>
            </div>
          ...
          <table width="100%" >
                    ...
                    <td valign="top">
                        <table align="left" >
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtMeetingTypeOther" Text='<%# Eval("Meeting_Type_Other") %>' CssClass="meetingTypeOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator ID="MaxLengthValidator42" runat="server" ControlToValidate="txtMeetingTypeOther" ErrorMessage="Meeting Type notes must be less than 150 characters." MaxLength="150" Display="None" />
                                </td>
                            </tr>                               
                            <tr align="left">
                                <td colspan="2"><label>Products Discussed</label></td>                                
                           ...
                           <tr align="left">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtMeetingOutcomeOther" Text='<%# Eval("Meeting_Outcome_Other") %>' CssClass="meetingOutcomeOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator runat="server" ControlToValidate="txtMeetingOutcomeOther" ErrorMessage="Meeting Outcome notes must be less than 150 characters." MaxLength="150" Display="None" />
                                </td>
                            </tr>                            
                            <tr align="left">
                                <td width="130px">                                    
                    ...
                    <td valign="top">
                        <table cellpadding="2" cellspacing="2" >
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtMeetingActivityOther" Text='<%# Eval("Meeting_Activity_Other") %>' CssClass="meetingActivityOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator ID="MaxLengthValidator52" runat="server" ControlToValidate="txtMeetingActivityOther" ErrorMessage="Meeting Activity notes must be less than 150 characters." MaxLength="150" Display="None" />
                                </td>
                            </tr>                             
                            <tr align="left">
                                <td colspan="2">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtFollowupNotesOther" Text='<%# Eval("Followup_Notes_Other") %>' CssClass="followupNotesOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator runat="server" MaxLength="150" ControlToValidate="txtFollowupNotesOther" ErrorMessage="Followup Notes must be less than 150 characters." Display="None" />
                                </td>
                            </tr>                                             
                        </table>
                    </td>                  
            ...
            <div class="modalFormButtons">
                <span class="coreBtn">
                    <span class="bg">
                        <span class="bg2">
                            <asp:Button TabIndex="9" ID="btnEdit" runat="server" Text="Add" Visible="true" OnClick="Editbtn_Click" />
                        </span>
                    </span>
                </span>
                <span class="coreBtn">
    ...
    <asp:EntityDataSource  runat="server" ID="dsFollowUpNotes" 
        ...
        DefaultContainerName="PathfinderClientEntities" 
        EntitySetName="LkpFollowupNotesSet" OrderBy="it.Sort_Index, it.[Followup_Notes_Name]">
    </asp:EntityDataSource>
