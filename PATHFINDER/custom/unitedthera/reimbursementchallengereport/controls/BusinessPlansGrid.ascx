...
<div id="businessPlansView">
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCCDocuments" AllowSorting="True" EnableEmbeddedSkins="False" PageSize="10" GridLines="None">        
        <MasterTableView autogeneratecolumns="false" ClientDataKeyNames="Document_ID" AllowPaging="true" Width="100%" PageSize="10">
            <Columns>
                <telerik:GridBoundColumn DataField="Document_Date" HeaderText='Document Date' HeaderStyle-Width="30%" SortExpression="Document_Date" UniqueName="Document_Date" DataType ="System.DateTime" DataFormatString="{0:M/dd/yyyy}" /> 
        ...
        <ClientSettings ClientEvents-OnRowSelecting="gridCCDocuments_OnRowSelecting">
            <DataBinding Location="~/custom/UnitedThera/reimbursementchallengereport/services/UnitedTheraDataService.svc" DataService-TableName="RCReportPlanDocumentsSet" >
            </DataBinding>
