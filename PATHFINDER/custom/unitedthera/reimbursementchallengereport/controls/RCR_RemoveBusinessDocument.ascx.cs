...
public partial class custom_controls_CCR_RemoveBusinessDocument : System.Web.UI.UserControl
{
    ...
    protected void Yesbtn_Click(object sender, EventArgs e)
    {
        ...
        using (PathfinderUnitedTheraEntities context = new PathfinderUnitedTheraEntities())
        {
                ...
                int documentID = Convert.ToInt32(Page.Request.QueryString["DocumentID"]);
                RCReportPlanDocuments planDocument = context.RCReportPlanDocumentsSet.FirstOrDefault(c => c.Document_ID == documentID);
