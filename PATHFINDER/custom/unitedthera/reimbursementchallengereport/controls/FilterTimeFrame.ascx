...
<div id ="timeFrame">
<div class="filterGeo">
    <input id="txtFrom" name="Contact_Date" class="datePicker" style="width:70px" type="text" /> - <input id="txtTo" name="Contact_Date" class="datePicker" style="width:70px" type="text" />
</div>
   <%--<div>
