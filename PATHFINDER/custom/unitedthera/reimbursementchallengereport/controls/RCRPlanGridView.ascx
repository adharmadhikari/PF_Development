<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RCRPlanGridView.ascx.cs" Inherits="custom_controls_CCRPlanGridView" %>
     ...
     <telerik:RadGrid SkinID="radTable" runat="server" ID="gridPlans" AllowSorting="True" EnableEmbeddedSkins="False" PageSize="50" AllowFilteringByColumn="true">        
       ...
       <PagerStyle Visible="false" />
        ...
        <ClientSettings ClientEvents-OnRowSelected="gridPlans_OnRowSelected">
            <DataBinding Location="~/custom/unitedthera/reimbursemnetchallengereport/services/UnitedTheraDataService.svc" DataService-TableName="PlanGridSet"  >
            </DataBinding>
