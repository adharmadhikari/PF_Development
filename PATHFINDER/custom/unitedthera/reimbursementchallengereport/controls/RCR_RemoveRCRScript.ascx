<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RCR_RemoveRCRScript.ascx.cs" Inherits="custom_Alcon_customercontactreports_controls_CCR_RemoveCCRScript" %>
