...
<table style="width:100%; padding-top: 5px;"  align="center">
    ...
    <tr>
     ...
     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="FileUpload1" CssClass="rfv" runat="server" ErrorMessage="Please browse and enter a document to upload" />
            <asp:Label ID = "hdnLbl2" runat ="server" Text="" Visible ="false" ForeColor="Red"></asp:Label>
        
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="bpsName" CssClass="rfv" runat="server" ErrorMessage="Please enter a document name" />
