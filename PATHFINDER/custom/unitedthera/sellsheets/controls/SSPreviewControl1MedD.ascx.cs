...
public partial class custom_controls_SSPreviewControl1MedD : System.Web.UI.UserControl
{
    ...
    {
        dsSellSheetReviewPlansListMedD.ConnectionString = Pinsonault.Web.Session.ClientDBConnectionString;
        dsSellSheetReviewPlansListMedicaid.ConnectionString = Pinsonault.Web.Session.ClientDBConnectionString;
            ...
            //{
                ...
                if (ssMast.Include_Territory_Name == true)
                {
                    if (!String.IsNullOrEmpty(ssMast.Geography_Name.ToString()))
                        geolbl.Text = ssMast.Geography_Name.ToString();
                }
