...
<telerik:RadGrid SkinID="radTable" Width="100%" runat="server" ID="gridCompletedSellSheets" AllowSorting="true"  AllowFilteringByColumn="false" EnableEmbeddedSkins="false">        
    ...
    <ClientSettings ClientEvents-OnRowSelecting="gridCompletedSellSheets_OnRowSelecting">
          <DataBinding Location="~/custom/pinso/sellsheets/services/pathfinderdataservice.svc" DataService-TableName="CompletedSellSheetsSet" SelectCountMethod="GetCompletedSellSheetCount" />
          <Scrolling AllowScroll="true" UseStaticHeaders="true" ScrollHeight="240px" />
          <Selecting AllowRowSelect="true" /> 
    </ClientSettings>
</telerik:RadGrid>
<pinso:RadGridWrapper runat="server" ID="radGridWrapper" ShowNumberOfRecords="false" Target="gridCompletedSellSheets" PagingSelector="#CompletedSellSheetsHeader .pagination"  CustomPaging="false"  MergeRows="false" RequiresFilter="false" AutoUpdate="false" AutoLoad="true"
