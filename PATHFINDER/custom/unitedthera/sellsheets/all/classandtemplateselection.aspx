<%@ Page Title="" Language="C#" EnableViewState="true" MasterPageFile="~/custom/MasterPages/SellSheetStep.master" AutoEventWireup="true" CodeFile="classandtemplateselection.aspx.cs" Inherits="custom_unitedthera_sellsheets_classandtemplateselection" %>
...
//            //Select United Thera's Market Basket(TheraID: 3 for "Therapeutic Class – Cardiovascular (PAH)") by default.
//            thera_id.selectItem(3);

//            //Select Adcirca  (DrugID: 3500) as default drug.
//            drugListOptions[0].ID = 3500;
//            drugListOptions[0].Name = 'Adcirca';

//            //Update hidden field with default theraid.
//            $("#<%= txtTheraID.ClientID %>").val('3');
...
//code fix to show the selected drug for edit sell sheet
            ...
            {
                //Select United Thera's Market Basket(TheraID: 48 for "Therapeutic Class – United Thera") by default.
                thera_id.selectItem(48);
                //Update hidden field with default theraid.
               $("#<%= txtTheraID.ClientID %>").val('48');
            ...
            else
            {
               ...
               //Select Adcirca  (DrugID: 3500) as default drug.
                drug_id.selectItem(3500);
                //Update hidden field with default drugid and theraid.
                $("#<%= txtDrugID.ClientID %>").val('3500|48');
