<%@ Page Title="" Language="C#" MasterPageFile="~/custom/MasterPages/SellSheetStep.master" AutoEventWireup="true" CodeFile="geographyselection.aspx.cs" Inherits="custom_unitedthera_sellsheets_geographyselection" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <script type="text/javascript">
        ...
        function ssMap_click(event, areaID, label)
        {
            ...
            {
                $alert("Please select only one state");
