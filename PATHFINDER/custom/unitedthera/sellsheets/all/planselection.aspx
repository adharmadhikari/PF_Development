<%@ Page Title="" Language="C#" MasterPageFile="~/custom/MasterPages/SellSheetStep.master" AutoEventWireup="true" CodeFile="planselection.aspx.cs" Inherits="custom_unitedthera_sellsheets_planselection" %>
<%@ MasterType VirtualPath="~/custom/MasterPages/SellSheetStep.master" %>
<%@ Register src="~/custom/unitedthera/sellsheets/controls/PlanSelectionScript.ascx" tagname="PlanSelectionScript" tagprefix="pinso" %>
  ...
  <div>
   ...
   <div class="AddAcct" ><span class="ssBold"><a id="AddAcctLnk" href="javascript:OpenAddAccount();">Add an Account</a></span></div> 
    ...
    <telerik:RadGrid SkinID="radTable"  ClientSettings-Selecting-AllowRowSelect="false" runat="server" ID="gridPlanSelectionList" AllowSorting="true"  AllowFilteringByColumn="false" EnableEmbeddedSkins="false" DataSourceID="dsSellSheetPlansList" AllowPaging="false" >        
           ...
           <Columns >
                <telerik:GridTemplateColumn UniqueName="CheckboxTemplate" HeaderStyle-CssClass="postback planSelectHeader" HeaderStyle-Width="3%"  FooterStyle-CssClass="bottom">
                    <ItemTemplate>
                        ...
                        <asp:CheckBox ID="chkSelectedPlan" runat="server" Checked='<%# Eval("Is_Selected") %>' onclick='<%# string.Format("PlanSelectionChanged(this,{0},{1},{2},{3})", Eval("Plan_ID"), Eval("Formulary_ID"), Eval("Product_ID"), Eval("Segment_ID")) %>' />
                        </span>
                    </ItemTemplate>
                ...
                <telerik:GridBoundColumn DataField="Plan_Pharmacy_Lives" HeaderText="Pharmacy Lives" UniqueName="Plan_Pharmacy_Lives" HeaderStyle-Width="9%" DataFormatString="{0:n0}"  ItemStyle-CssClass="alignRight"  HeaderStyle-CssClass="rgHeader planSelectHeader postback" HeaderStyle-Font-Bold="true" FooterStyle-CssClass="bottom"/>
                ...
                <telerik:GridBoundColumn DataField="FirstTierName" UniqueName="FirstTierName" HeaderText="PA/QL/ST" HeaderStyle-Width="7%" HeaderStyle-CssClass="rgHeader planSelectHeader postback " HeaderStyle-Font-Bold="true" FooterStyle-CssClass="bottom"/>
                ...
                <telerik:GridBoundColumn DataField="SecondTierName" UniqueName="SecondTierName" HeaderText="PA/QL/ST" HeaderStyle-Width="7%" HeaderStyle-CssClass="rgHeader planSelectHeader postback"  HeaderStyle-Font-Bold="true" FooterStyle-CssClass="bottom"/>
                ...
                <telerik:GridBoundColumn DataField="ThirdTierName" UniqueName="ThirdTierName" HeaderText="PA/QL/ST" HeaderStyle-Width="7%" HeaderStyle-CssClass="rgHeader planSelectHeader postback" HeaderStyle-Font-Bold="true" FooterStyle-CssClass="bottom"/>
        ...
        <SortExpressions>
            <telerik:GridSortExpression FieldName ="Plan_Pharmacy_Lives" SortOrder ="Descending" /> 
        </SortExpressions> 
        </MasterTableView>   
