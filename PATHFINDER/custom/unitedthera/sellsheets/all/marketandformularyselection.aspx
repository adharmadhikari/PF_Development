<%@ Page Title="" Language="C#" EnableViewState="true" MasterPageFile="~/custom/MasterPages/SellSheetStep.master" AutoEventWireup="true" CodeFile="marketandformularyselection.aspx.cs" Inherits="custom_unitedthera_sellsheets_marketandformularyselection" %>
...
<div id="divIndent">
        ...
        <div>
            <asp:RadioButtonList ID="rblCopay" runat="server" Enabled="false" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="listItemWidth">
