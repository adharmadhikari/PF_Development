<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SingleSection.master" AutoEventWireup="true" CodeFile="customercontactdrilldown.aspx.cs" Inherits="custom_reckitt_customercontactreports_all_customcontactdrilldown" %>
<%--<%@ Register src="~/custom/controls/CCRDrilldownScript.ascx" tagname="CDrilldownScript" tagprefix="pinso" %>--%>
<%@ Register src="~/custom/reckitt/customercontactreports/controls/CCRDrilldownData.ascx" tagname="CDrilldownData" tagprefix="pinso" %>
