<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Pyramid.master" AutoEventWireup="true" CodeFile="meetingactivity.aspx.cs" EnableViewState="true" Inherits="custom_reckitt_customercontactreports_all_meetingactivity" %>
<%@ Register src="~/custom/reckitt/customercontactreports/controls/ccrChart.ascx" tagname="ccrChart" tagprefix="pinso" %>
<%@ Register src="~/custom/reckitt/customercontactreports/controls/ccrMeetingActivityData.ascx" tagname="ccrMeetingActivityData" tagprefix="pinso" %>
<%@ Register src="~/custom/reckitt/customercontactreports/controls/ccrMeetingActivityDrillDown.ascx" tagname="ccrMeetingActivityDrillDown" tagprefix="pinso" %>
<%@ Register src="~/custom/reckitt/customercontactreports/controls/ccrMeetingActivityScript.ascx" tagname="ccrMeetingActivityScript" tagprefix="pinso" %>
