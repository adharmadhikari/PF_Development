<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Pyramid.master" AutoEventWireup="true" CodeFile="meetingtype.aspx.cs" Inherits="custom_reckitt_customercontactreports_all_meetingtype" %>
<%@ Register src="~/custom/reckitt/customercontactreports/controls/ccrChart.ascx" tagname="ccrChart" tagprefix="pinso" %>
<%@ Register Src="~/custom/reckitt/customercontactreports/controls/ccrMeetingTypeData.ascx" tagname="ccrMeetingTypeData" tagprefix="pinso"%>
<%@ Register Src="~/custom/reckitt/customercontactreports/controls/ccrMeetingTypeDrillDown.ascx" tagname="ccrMeetingTypeDrillDown" tagprefix="pinso"%>
<%@ Register Src="~/custom/reckitt/customercontactreports/controls/ccrMeetingTypeScript.ascx" tagname ="ccrMeetingTypeScript" TagPrefix="pinso" %>
