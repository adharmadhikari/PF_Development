<%@ Page Title="" Language="C#" MasterPageFile="~/custom/MasterPages/CustomerContactReport.master" AutoEventWireup="true" CodeFile="customercontactreport.aspx.cs" Inherits="custom_reckitt_customercontactreports_all_customercontactreport" %>
<%@ Register Src="~/custom/reckitt/customercontactreports/controls/CCRGridView.ascx" TagName="CCRGridList" TagPrefix="pinso" %>
<%@ Register Src="~/custom/reckitt/customercontactreports/controls/BusinessPlansGrid.ascx" TagName="CCBusinessDocument" TagPrefix="pinso" %>
<%@ Register Src="~/custom/reckitt/customercontactreports/controls/CCRPlanGridView.ascx" TagName="CCPlanGrid" TagPrefix="pinso" %>
<%@ Register Src="~/custom/reckitt/customercontactreports/controls/CCReportScripts.ascx" TagName="CCPlanScript" TagPrefix="pinso" %>
