    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using ( PathfinderClientModel.PathfinderClientEntities clientContext = new PathfinderClientModel.PathfinderClientEntities(Pinsonault.Web.Session.ClientConnectionString) )
        {
            ...
            if (productId.Count() >= 1)
            {
                ...
                meetingActivityFilterProd1 = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingActivityFilterProd1National = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
            ...
            if (productId.Count() >= 2)
            {
                ...
                meetingActivityFilterProd2 = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingActivityFilterProd2National = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
            ...
            if (productId.Count() == 3)
            {
                ...
                meetingActivityFilterProd3 = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingActivityFilterProd3National = Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
