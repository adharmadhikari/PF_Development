                           ...
                           <tr align="left">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    ...
                                    <pinso:MaxLengthValidator ID="MaxLengthValidator2" runat="server" ControlToValidate="txtMeetingOutcomeOther" ErrorMessage="Meeting Outcome notes must be less than 250 characters." MaxLength="250" Display="None" />
                                </td>
                            </tr>                                
                            <tr align="left">
                                <td width="130px">                                    
                        ...
                        <table cellpadding="2" cellspacing="2" >
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    ...
                                    <pinso:MaxLengthValidator ID="MaxLengthValidator1" runat="server" MaxLength="250" ControlToValidate="txtFollowupNotesOther" ErrorMessage="Followup Notes must be less than 250 characters." Display="None" />
                                </td>
                            </tr>                                                                                          
                        </table>
                    </td>                  
                        ...
                        <table align="left" >
                           ...
                           <tr align="left">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtMeetingOutcomeOther" Text='<%# Eval("Meeting_Outcome_Other") %>' CssClass="meetingOutcomeOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator runat="server" ControlToValidate="txtMeetingOutcomeOther" ErrorMessage="Meeting Outcome notes must be less than 250 characters." MaxLength="250" Display="None" />
                                </td>
                            </tr>                            
                            <tr align="left">
                                <td width="130px">                                    
                    ...
                    <td valign="top">
                        <table cellpadding="2" cellspacing="2" >
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtFollowupNotesOther" Text='<%# Eval("Followup_Notes_Other") %>' CssClass="followupNotesOther" TextMode="MultiLine" Rows="4" Width="99%" />
                                    <pinso:MaxLengthValidator runat="server" MaxLength="250" ControlToValidate="txtFollowupNotesOther" ErrorMessage="Followup Notes must be less than 250 characters." Display="None" />
                                </td>
                            </tr>                                             
                        </table>
                    </td>                  
