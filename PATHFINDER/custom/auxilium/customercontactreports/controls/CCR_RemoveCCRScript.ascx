<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCR_RemoveCCRScript.ascx.cs" Inherits="custom_auxilium_customercontactreports_controls_CCR_RemoveCCRScript" %>
