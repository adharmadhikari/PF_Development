<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BusinessPlansGrid.ascx.cs" Inherits="custom_auxilium_customercontactreports_controls_BusinessPlansGrid" %>
<div id="businessPlansView">
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCCDocuments" AllowSorting="True" EnableEmbeddedSkins="False" PageSize="10" GridLines="None">        
        ...
        <ClientSettings ClientEvents-OnRowSelecting="gridCCDocuments_OnRowSelecting">
            <DataBinding Location="~/custom/pinso/customercontactreports/services/PathfinderDataService.svc" DataService-TableName="PlanDocumentsViewSet" SelectCountMethod ="GetDocumentCount">
            </DataBinding>
