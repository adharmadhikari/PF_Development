<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCRGridView.ascx.cs" Inherits="custom_auxilium_customercontactreports_controls_CCRGridView" %>
<div id="ccrView">
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCCReports" AllowSorting="True" EnableEmbeddedSkins="False" PageSize="50">        
        ...
        <ClientSettings>
            <DataBinding Location="~/custom/auxilium/customercontactreports/services/PathfinderDataService.svc" DataService-TableName="ContactReportProductsDiscussedViewSet" SelectCountMethod ="GetCCReportCount">
            </DataBinding>
