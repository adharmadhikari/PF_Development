...
public partial class custom_auxilium_customercontactreports_all_productsdiscussed : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(strwhere))
        {
            using (Pinsonault.Application.Auxilium.PathfinderAuxiliumEntities ctx = new Pinsonault.Application.Auxilium.PathfinderAuxiliumEntities())
            {
        ...
        using (PathfinderClientModel.PathfinderClientEntities clientContext = new PathfinderClientModel.PathfinderClientEntities(Pinsonault.Web.Session.ClientConnectionString))
        {
            ...
            {
                prodDiscFilterProd2 = Pinsonault.Data.Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValues)).ToList();
            ...
            prodDiscFilterProd1 = Pinsonault.Data.Generic.CreateGenericEntityQuery<PathfinderClientModel.ContactReportDataSummary>(clientContext, new QueryDefinition(queryValues)).ToList();
