<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Pyramid.master" AutoEventWireup="true" CodeFile="productsdiscussed.aspx.cs" Inherits="custom_auxilium_customercontactreports_all_productsdiscussed" %>
<%@ Register src="~/custom/auxilium/customercontactreports/controls/ccrChart.ascx" tagname="ccrChart" tagprefix="pinso" %>
<%@ Register src="~/custom/auxilium/customercontactreports/controls/ccrProductsDiscussedData.ascx" tagname="ccrProductsDiscussedData" tagprefix="pinso" %>
<%@ Register src="~/custom/auxilium/customercontactreports/controls/ccrProductsDiscussedDrillDown.ascx" tagname="ccrProductsDiscussedDrillDown" tagprefix="pinso" %>
<%@ Register src="~/custom/auxilium/customercontactreports/controls/ccrProductsDiscussedScript.ascx" tagname="ccrProductsDiscussedScript" tagprefix="pinso" %>
