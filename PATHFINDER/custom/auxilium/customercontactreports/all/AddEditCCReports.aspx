<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true"
    CodeFile="AddEditCCReports.aspx.cs" Inherits="custom_auxilium_customercontactreports_all_AddEditCCReports" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register src="~/custom/auxilium/customercontactreports/controls/AddEditCCRScript.ascx" tagname="CCRScript" tagprefix="pinso" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="Server">
    ...
    <asp:EntityDataSource runat="server" ID="dsMeetingType" ConnectionString="name=PathfinderAuxiliumEntities"
        DefaultContainerName="PathfinderAuxiliumEntities" EntitySetName="LkpMeetingTypeSet"
        EntityTypeFilter="LkpMeetingType" OrderBy="it.[Meeting_Type_Name]">
    </asp:EntityDataSource>
    <asp:EntityDataSource runat="server" ID="dsMeetingActivity" ConnectionString="name=PathfinderAuxiliumEntities"
        DefaultContainerName="PathfinderAuxiliumEntities" 
        EntitySetName="LkpMeetingActivitySet" OrderBy="it.[Meeting_Activity_Name]">
    </asp:EntityDataSource>
    <asp:EntityDataSource runat="server" ID="dsProductsDiscussed" ConnectionString="name=PathfinderAuxiliumEntities"
        DefaultContainerName="PathfinderAuxiliumEntities" EntitySetName="LkpProductsDiscussedSet"
        EntityTypeFilter="LkpProductsDiscussed" OrderBy="it.[Drug_Name]">
    </asp:EntityDataSource>
    <asp:EntityDataSource runat="server" ID="dsContactReport" ConnectionString="name=PathfinderAuxiliumEntities"
        DefaultContainerName="PathfinderAuxiliumEntities" 
    ...
    <asp:EntityDataSource  runat="server" ID="dsFollowUpNotes" 
        ConnectionString="name=PathfinderAuxiliumEntities" 
        DefaultContainerName="PathfinderAuxiliumEntities" 
