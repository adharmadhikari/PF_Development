...
public partial class custom_pinso_sellsheets_all_EmailSellSheet : PageBase
{
    ...
    {
        string[] host = txtEmail.Text.Split('@');
        string hostName = host[1];
        if (hostName.ToLower() == "alconlabs.com" || hostName.ToLower() == "pinsonault.com")
                {
                ...
                {
                    vldEmail_domain.ErrorMessage = "Invalid - Domain name is not alconlabs.";
                    vldEmail_domain.IsValid = false;
                }
    }
}
