<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="SaveSellSheet.aspx.cs" Inherits="custom_pinso_sellsheets_SaveSellSheet"  EnableViewState="true"  %>
<%@ OutputCache NoStore="true" Duration="1" VaryByParam="None" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <script type="text/javascript">
     function RefreshPage(sheetID) {
         window.parent.$("#ExportSellSheet").removeAttr("disabled");
         window.parent.$("#ExportSellSheet").attr("href", "javascript:openPDFPreview(" + sheetID + ")");
         window.parent.$("#ExportSellSheet").find('img').removeClass('disableimg');
         window.parent.$("#iframeTable").load();
