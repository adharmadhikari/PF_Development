<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="EmailSellSheet.aspx.cs" Inherits="custom_pinso_sellsheets_all_EmailSellSheet" %>
    ...
    <table>    
        <tr>
            ...
            <td align="left">
                ...
                <pinso:ClientValidator ID="vldEmail" runat="server" Text="Invalid - Email address is required." Target="txtEmail" Required="true"  />
                <asp:CustomValidator ID="vldEmail_domain" runat="server" ControlToValidate="txtEmail" Display="Dynamic" />
            </td>
        </tr>
        <tr>
            <td>
