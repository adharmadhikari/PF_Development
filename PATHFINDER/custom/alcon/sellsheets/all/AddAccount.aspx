...
<table>
    <tr>
        ...
        <td>
          ...
          <telerik:RadComboBox ID="rdcmbMktSegment" runat="server" DropDownWidth="250px"  
             Height="120px" EnableEmbeddedSkins="false" SkinID="planInfoCombo" 
             Skin="pathfinder" AppendDataBoundItems="true" 
             DataTextField="Name" DataValueField="ID"  AutoPostBack="true"  
             OnSelectedIndexChanged="rdcmbMktSegment_SelectedIndexChanged">
            </telerik:RadComboBox>
            <%-- <telerik:RadComboBox ID="rdcmbMktSegment" runat="server" DropDownWidth="250px"  
             EnableEmbeddedSkins="false" SkinID="planInfoCombo" 
             Skin="pathfinder" AutoPostBack="true"  OnSelectedIndexChanged="rdcmbMktSegment_SelectedIndexChanged">
                <Items>
                    <telerik:RadComboBoxItem Value="1" Text="Commercial Player" Selected="true" />
                    <telerik:RadComboBoxItem Value="4" Text="PBM" />
                    <telerik:RadComboBoxItem Value="12" Text="DOD" />
                </Items>
            </telerik:RadComboBox>--%>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
             <telerik:RadComboBox ID="rdcmbPlans" runat="server" DropDownWidth="220px" Height="80px"  
              EnableEmbeddedSkins="false" SkinID="planInfoCombo" Skin="pathfinder" 
              AppendDataBoundItems="true" DataSourceID="dsPlans" DataTextField="Plan_Name" 
              DataValueField="Plan_ID" OnSelectedIndexChanged="rdcmbPlans_SelectedIndexChanged" 
              OnDataBound="rdcmbPlans_OnDataBound" Visible="true" >
            </telerik:RadComboBox>
        </td>
    </tr>
    <tr>
