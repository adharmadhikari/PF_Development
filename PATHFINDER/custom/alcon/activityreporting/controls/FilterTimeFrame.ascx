...
<div id ="timeFrame">
<div class="filterGeo">
    <input id="txtFrom" name="Activity_Date" class="datePicker" style="width:70px" type="text" /> - <input id="txtTo" name="Activity_Date" class="datePicker" style="width:70px" type="text" />
</div>
   <%--<div>
