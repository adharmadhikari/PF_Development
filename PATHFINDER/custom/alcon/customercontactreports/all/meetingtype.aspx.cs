    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (PathfinderAlconEntities  clientContext = new PathfinderAlconEntities())
        {
            ...
            for (int i = 0; i < productId.Length; i++)
            {
                ...
                qd = new MeetingTypeCustomerContactReportQueryDef("ContactReportDataSummaryEx", queryValues);
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    qd = new MeetingTypeCustomerContactReportQueryDef("ContactReportDataSummaryEx", queryValueNational);
