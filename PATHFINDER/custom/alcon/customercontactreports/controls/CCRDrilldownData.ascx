<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCRDrilldownData.ascx.cs" Inherits="custom_controls_CCRDrilldownData" %>
  ...
  <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCR" AllowSorting="true"   
        ...
        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="Plan_Name, Geography_Name, Contact_Date, Meeting_Activity_Name, Meeting_Type_Name" PageSize="50"
         AllowMultiColumnSorting="true" Width="100%" >
            <Columns>
            <telerik:GridBoundColumn DataField="Account_Manager" HeaderStyle-Width="11%" ItemStyle-CssClass="firstCol planName"
             ...
             <telerik:GridBoundColumn DataField="Geography_Name" HeaderText="Geography" ItemStyle-CssClass="geogName"
                          UniqueName="Geography_Name" DataType="System.String" HeaderStyle-Width="13%"></telerik:GridBoundColumn>
             ...
             <telerik:GridBoundColumn DataField="Contact_Date" HeaderText='<%$ Resources:Resource, Label_CR_Date %>' ItemStyle-CssClass="alignRight contactDT"
                ...
                <telerik:GridBoundColumn DataField="Persons_Met" HeaderText="Persons Met" ItemStyle-CssClass="PersonsMet"
                          UniqueName="Persons_Met" DataType="System.String" HeaderStyle-Width="18%" />
            
             <telerik:GridBoundColumn DataField="Section_Name" HeaderText="Market Segment" ItemStyle-CssClass="sectName"
                        UniqueName="Section_Name" DataType="System.String" HeaderStyle-Width="13%" />
             ...
             <telerik:GridBoundColumn DataField="Meeting_Activity_Name" HeaderText='<%$ Resources:Resource, Label_Meeting_Activity %>' ItemStyle-CssClass="meetActivity"
                        UniqueName="Meeting_Activity_Name"  DataType ="System.String" HeaderStyle-Width="12%"/>  
             ...
             <telerik:GridBoundColumn DataField="Meeting_Type_Name" HeaderText='<%$ Resources:Resource, Label_Meeting_Type %>' ItemStyle-CssClass="meetType"
                        UniqueName="Meeting_Type_Name" DataType = "System.String" HeaderStyle-Width="12%"/>       
                       
             <%--<telerik:GridBoundColumn DataField="Followup_Notes_Name" HeaderText="Followup Notes" ItemStyle-CssClass="followNotes"
                        UniqueName="Followup_Notes_Name" DataType = "System.String" />--%>    
             
             <%--<telerik:GridBoundColumn DataField="Meeting_Outcome_Name" HeaderText="Meeting Outcome" ItemStyle-CssClass="meetOutcome"
                        UniqueName="Meeting_Outcome_Name" DataType = "System.String" />--%>                           
                                       
             <telerik:GridBoundColumn DataField="Drug_Name" HeaderText="Drug" HeaderStyle-Width="13%" ItemStyle-CssClass="notmerged drugName" 
       ...
       <ClientSettings >
            <DataBinding Location="~/custom/Alcon/customercontactreports/services/AlconDataService.svc" DataService-TableName="ContactReportDrilldownSet" 
                 />  
   ...
   <pinso:RadGridWrapper runat="server" ID="radGridWrapper" Target="gridCR"  MergeRows="false" PagingSelector="#divTile3Container .pagination" OnClientDataBinding="OnDrilldownDataBinding" RequiresFilter="true" AutoUpdate="true" UtcDateColumns="Contact_Date" />
