...
<div class="filterGeo">
    <asp:Literal runat="server" ID="filterLabel" Visible="false" Text="Meeting Followup" />
    
</div>
<telerik:RadComboBox ID="Followup_Notes_ID" Visible="false" runat="server" EnableEmbeddedSkins="false" Skin="pathfinder" AppendDataBoundItems="true" CssClass="queryExt">
