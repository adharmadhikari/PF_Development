...
<div id="ccrView">
    <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCCReports" AllowSorting="True" EnableEmbeddedSkins="False" PageSize="50">        
        ...
        <ClientSettings ClientEvents-OnRowSelecting="gridCCReports_OnRowSelecting">
            <DataBinding Location="~/custom/Alcon/customercontactreports/services/PathfinderDataService.svc" DataService-TableName="ContactReportProductsDiscussedViewSet" SelectCountMethod ="GetCCReportCount">
            </DataBinding>
