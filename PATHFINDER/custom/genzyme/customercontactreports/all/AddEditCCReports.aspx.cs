...
public partial class custom_pinso_customercontactreports_all_AddEditCCReports : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            Page.ClientScript.RegisterStartupScript(typeof(Page), "UpdateMeetingActivity", "UpdMeetingActivitySelection();", true);
...
//            Print.Visible = Request.QueryString["LinkClicked"].Equals("EditCCR");
    ...
    protected void setComboValues()
    {
        ...
        else { hdnPrdsDisccused.Value = ""; hdnMeetOutcome.Value = ""; hdnFollowupNotes.Value = ""; hdnMeetActivity.Value = "";  hdnKeyContacts.Value = ""; }
        ...
        using (PathfinderGenzymeEntities context = new PathfinderGenzymeEntities())
            {
                ...
                // There can be multiple Products Discussed, Meeting Activity, FollowUp Notes, Meeting Outcomes, KeyContacts  for any Report
