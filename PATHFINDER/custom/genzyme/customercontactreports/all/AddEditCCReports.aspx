...
<%@ Register src="~/custom/genzyme/customercontactreports/controls/AddEditCCRScript.ascx" tagname="CCRScript" tagprefix="pinso" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="Server">
                        ...
                        <table cellpadding="2" cellspacing="2" >
                            ...
                            <tr align="left">
                                ...
                                <td>
                                  ...
                                  <telerik:RadComboBox runat="server" ID="rdlMeetingActivity" DataSourceID="dsMeetingActivity"
                                    ...
                                    EnableEmbeddedSkins="false" DataTextField="Meeting_Activity_Name" DataValueField="Meeting_Activity_ID"
                                    AppendDataBoundItems="true" AllowCustomText="True" Text="-Select Meeting Activity-" OnClientDropDownClosed="setMeetActivityText" OnClientLoad="setMeetActivityText">
                                     <ItemTemplate>
                            ...
                            <%--<tr align="left">
                                <td colspan="2" style="padding-left: 5px;padding-bottom : 2px;">                                   
                                     <asp:TextBox id="txtKeyContactsOther" Columns = "64" MaxLength="255"  Rows="4" TextMode="MultiLine" runat="server" Text='<%# Eval("Key_Contacts_Other") %>' />                                                                    
    ...
    <asp:EntityDataSource runat="server" ID="dsMeetingType" DefaultContainerName="PathfinderGenzymeEntities"  ConnectionString="name=PathfinderGenzymeEntities"
        ContextTypeName="Pinsonault.Application.Genzyme.PathfinderGenzymeEntities, Pinsonault.Application.Genzyme" EntitySetName="LkpMeetingTypeSet"
        EntityTypeFilter="LkpMeetingType" OrderBy="it.Sort_Index, it.[Meeting_Type_Name]">
    </asp:EntityDataSource>
    <asp:EntityDataSource runat="server" ID="dsMeetingActivity" DefaultContainerName="PathfinderGenzymeEntities"  ConnectionString="name=PathfinderGenzymeEntities"
        ContextTypeName="Pinsonault.Application.Genzyme.PathfinderGenzymeEntities, Pinsonault.Application.Genzyme"
        EntitySetName="LkpMeetingActivitySet" OrderBy="it.Sort_Index, it.[Meeting_Activity_Name]">
    </asp:EntityDataSource>
    <asp:EntityDataSource runat="server" ID="dsProductsDiscussed" DefaultContainerName="PathfinderGenzymeEntities"  ConnectionString="name=PathfinderGenzymeEntities"
        ContextTypeName="Pinsonault.Application.Genzyme.PathfinderGenzymeEntities, Pinsonault.Application.Genzyme" EntitySetName="LkpProductsDiscussedSet"
        EntityTypeFilter="LkpProductsDiscussed" OrderBy="it.Sort_Index, it.[Drug_Name]">
    </asp:EntityDataSource>
 
    <asp:EntityDataSource runat="server" ID="dsContactReport" DefaultContainerName="PathfinderGenzymeEntities"  ConnectionString="name=PathfinderGenzymeEntities"
        ContextTypeName="Pinsonault.Application.Genzyme.PathfinderGenzymeEntities, Pinsonault.Application.Genzyme"
    ...
    <asp:EntityDataSource  runat="server" ID="dsFollowUpNotes" 
        DefaultContainerName="PathfinderGenzymeEntities"  ConnectionString="name=PathfinderGenzymeEntities"
        ContextTypeName="Pinsonault.Application.Genzyme.PathfinderGenzymeEntities, Pinsonault.Application.Genzyme"
