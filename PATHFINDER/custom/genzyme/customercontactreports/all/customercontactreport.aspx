...
<%@ Register Src="~/custom/genzyme/customercontactreports/controls/CCRGridView.ascx" TagName="CCRGridList" TagPrefix="pinso" %>
<%@ Register Src="~/custom/genzyme/customercontactreports/controls/BusinessPlansGrid.ascx" TagName="CCBusinessDocument" TagPrefix="pinso" %>
<%@ Register Src="~/custom/genzyme/customercontactreports/controls/CCRPlanGridView.ascx" TagName="CCPlanGrid" TagPrefix="pinso" %>
<%@ Register Src="~/custom/genzyme/customercontactreports/controls/CCReportScripts.ascx" TagName="CCPlanScript" TagPrefix="pinso" %>
