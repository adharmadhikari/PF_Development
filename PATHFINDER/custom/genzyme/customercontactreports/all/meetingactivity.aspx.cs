    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (PathfinderGenzymeEntities clientContext = new PathfinderGenzymeEntities())
        {
            ...
            if (productId.Count() >= 1)
            {
                ...
                meetingActivityFilterProd1 = Pinsonault.Data.Generic.CreateGenericEntityQuery<Pinsonault.Application.Genzyme.ContactReportMeetingActivitySummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                if (meetingActivityFilterProd1.Count() > 0)
                {
                    ...
                    cr.ProcessGenzymeChart(chart1, meetingActivityFilterProd1.ToList(), prodID, "meetingactivity", 1);
                    cr.ProcessGenzymeGrid(grid1, meetingActivityFilterProd1);
                }
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingActivityFilterProd1National = Pinsonault.Data.Generic.CreateGenericEntityQuery<Pinsonault.Application.Genzyme.ContactReportMeetingActivitySummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
                    ...
                    if (meetingActivityFilterProd1National.Count() > 0)
                    {
                        ...
                        prodID = Convert.ToInt32(productId[0]);
                        cr.ProcessGenzymeChart(chart1National, meetingActivityFilterProd1National.ToList(), prodID, "meetingactivity", 4);
                        cr.ProcessGenzymeGrid(grid1National, meetingActivityFilterProd1National);
                    }
                }
            }
            if (productId.Count() >= 2)
            {
                ...
                meetingActivityFilterProd2 = Pinsonault.Data.Generic.CreateGenericEntityQuery<Pinsonault.Application.Genzyme.ContactReportMeetingActivitySummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                if (meetingActivityFilterProd2.Count() > 0)
                {
                    ...
                    cr.ProcessGenzymeChart(chart2, meetingActivityFilterProd2.ToList(), prodID, "meetingactivity", 2);
                    cr.ProcessGenzymeGrid(grid2, meetingActivityFilterProd2);
                }
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingActivityFilterProd2National = Pinsonault.Data.Generic.CreateGenericEntityQuery<Pinsonault.Application.Genzyme.ContactReportMeetingActivitySummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
                    ...
                    if (meetingActivityFilterProd2National.Count() > 0)
                    {
                        ...
                        prodID = Convert.ToInt32(productId[1]);
                        cr.ProcessGenzymeChart(chart2National, meetingActivityFilterProd2National.ToList(), prodID, "meetingactivity", 5);
                        cr.ProcessGenzymeGrid(grid2National, meetingActivityFilterProd2National);
                    }
                }
            }
            if (productId.Count() == 3)
            {
                ...
                meetingActivityFilterProd3 = Pinsonault.Data.Generic.CreateGenericEntityQuery<Pinsonault.Application.Genzyme.ContactReportMeetingActivitySummary>(clientContext, new QueryDefinition(queryValues)).ToList();
                if (meetingActivityFilterProd3.Count() > 0)
                {
                    ...
                    cr.ProcessGenzymeChart(chart3, meetingActivityFilterProd3.ToList(), prodID, "meetingactivity", 3);
                    cr.ProcessGenzymeGrid(grid3, meetingActivityFilterProd3);
                }
                ...
                if (string.IsNullOrEmpty(Request.QueryString["Is_National"]))
                {
                    ...
                    meetingActivityFilterProd3National = Pinsonault.Data.Generic.CreateGenericEntityQuery<Pinsonault.Application.Genzyme.ContactReportMeetingActivitySummary>(clientContext, new QueryDefinition(queryValueNational)).ToList();
                    ...
                    if (meetingActivityFilterProd3National.Count() > 0)
                    {
                        ...
                        prodID = Convert.ToInt32(productId[2]);
                        cr.ProcessGenzymeChart(chart3National, meetingActivityFilterProd3National.ToList(), prodID, "meetingactivity", 6);
                        cr.ProcessGenzymeGrid(grid3National, meetingActivityFilterProd3National);
                    }
                }
            }
        }
