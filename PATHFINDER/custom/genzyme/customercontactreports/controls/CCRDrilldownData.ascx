<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCRDrilldownData.ascx.cs" Inherits="custom_controls_CCRDrilldownData" %>
  ...
  <telerik:RadGrid SkinID="radTable" runat="server" ID="gridCR" AllowSorting="true"   
       ...
       <ClientSettings >
            <DataBinding Location="~/custom/genzyme/customercontactreports/services/PathfinderDataService.svc" DataService-TableName="ContactReportDrillDownSet" 
                SelectCountMethod="GetCCRDrillDownCount"/>  
