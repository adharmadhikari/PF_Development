...
<script type="text/javascript">
    ...
    function UpdMeetingActivitySelection()
    {
        ...
        if (str)
        {
            ...
            for (var i = 0; i < a.length; i++)
            {
                $("#ctl00_main_formViewCCR_rdlMeetingActivity #y" + a[i] + " input").attr("checked", true);

                if ($.browser.msie && $.browser.version < 7)
                    $("#ctl00_main_formViewCCR_rdlMeetingActivity #y" + a[i] + " input").attr("defaultChecked", "defaultChecked");
...
//        }
    ...
    function MeetActivityChanged(sender, MeetActID)
    {
        ...
        if (sender.checked)
        {
            ...
            {
                sender.checked = false;
                $alert("A maximum of 10 activities can be selected.", "Meeting Activity");
            }
        }
        //        else 
        //        {
