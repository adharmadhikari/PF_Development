...
<%@ Register Src="~/custom/pinso/customercontactreports/controls/ccrMeetingTypeData.ascx" tagname="ccrMeetingTypeData" tagprefix="pinso"%>
<%@ Register Src="~/custom/pinso/customercontactreports/controls/ccrMeetingTypeDrillDown.ascx" tagname="ccrMeetingTypeDrillDown" tagprefix="pinso"%>
<%@ Register Src="~/custom/pinso/customercontactreports/controls/ccrMeetingTypeScript.ascx" tagname ="ccrMeetingTypeScript" TagPrefix="pinso" %>
