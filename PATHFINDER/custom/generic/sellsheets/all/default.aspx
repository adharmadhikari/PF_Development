...
<%@ Register src="~/custom/pinso/sellsheets/controls/CompletedSellSheets.ascx" tagname="CompletedSellSheets" tagprefix="pinso" %>
<%@ Register src="~/custom/pinso/sellsheets/controls/DraftedSellSheets.ascx" tagname="DraftedSellSheets" tagprefix="pinso" %>
<%@ Register src="~/custom/pinso/sellsheets/controls/SellSheetOrderList.ascx" tagname="SellSheetOrderList" tagprefix="pinso" %>
<%@ Register src="~/custom/pinso/sellsheets/controls/NewSellSheetOrder.ascx" tagname="NewSellSheetOrder" tagprefix="pinso" %>
<%@ Register src="~/custom/pinso/sellsheets/controls/SellSheetScript.ascx" tagname="SellSheetScript" tagprefix="pinso" %>
