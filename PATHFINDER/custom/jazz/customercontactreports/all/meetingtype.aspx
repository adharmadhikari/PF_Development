<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Pyramid.master" AutoEventWireup="true" CodeFile="meetingtype.aspx.cs" Inherits="custom_jazz_customercontactreports_all_meetingtype" %>
<%@ Register src="~/custom/jazz/customercontactreports/controls/ccrChart.ascx" tagname="ccrChart" tagprefix="pinso" %>
<%@ Register Src="~/custom/jazz/customercontactreports/controls/ccrMeetingTypeData.ascx" tagname="ccrMeetingTypeData" tagprefix="pinso"%>
<%@ Register Src="~/custom/jazz/customercontactreports/controls/ccrMeetingTypeDrillDown.ascx" tagname="ccrMeetingTypeDrillDown" tagprefix="pinso"%>
<%@ Register Src="~/custom/jazz/customercontactreports/controls/ccrMeetingTypeScript.ascx" tagname ="ccrMeetingTypeScript" TagPrefix="pinso" %>
