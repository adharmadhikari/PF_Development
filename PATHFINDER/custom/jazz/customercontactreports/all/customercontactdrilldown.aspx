<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SingleSection.master" AutoEventWireup="true" CodeFile="customercontactdrilldown.aspx.cs" Inherits="custom_jazz_customercontactreports_all_customcontactdrilldown" %>
<%--<%@ Register src="~/custom/controls/CCRDrilldownScript.ascx" tagname="CDrilldownScript" tagprefix="pinso" %>--%>
<%@ Register src="~/custom/jazz/customercontactreports/controls/CCRDrilldownData.ascx" tagname="CDrilldownData" tagprefix="pinso" %>
