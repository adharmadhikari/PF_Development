<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true"
    CodeFile="AddEditCCReports.aspx.cs" Inherits="custom_jazz_customercontactreports_all_AddEditCCReports" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register src="~/custom/jazz/customercontactreports/controls/AddEditCCRScript.ascx" tagname="CCRScript" tagprefix="pinso" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="tools" runat="server">  
     <a href="javascript:onPrintClicked()" style='margin-right:15px'><asp:Label ID="Print" runat="server" Text="Print" Visible="false" ></asp:Label></a>  
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="Server">
    ...
    <asp:FormView runat="server" ID="formViewCCR" CellPadding="0" Width="100%" DataSourceID="dsContactReport">
        <ItemTemplate>
                           ...
                           <tr align="left">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;padding-bottom : 2px;">                                  
                                   <asp:TextBox id="txtMeetingOutcomeOther" Columns = "64" MaxLength="255"  Rows="4" TextMode="MultiLine"  runat="server" Text='<%# Eval("Meeting_Outcome_Other") %>' />                                                                
                                </td>
                            </tr>
                            <%-- Meeting Outcome Text Field--%>
                    ...
                    <td valign="top">
                        <table cellpadding="2" cellspacing="2" >
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <telerik:RadComboBox ID="rdlKeyContacts" runat="server" AppendDataBoundItems="true"
                                        ...
                                        DataTextField="Full_Name" DataValueField ="KC_ID" EnableEmbeddedSkins="false" AllowCustomText="True" Text="-Select Persons Met-" OnClientDropDownClosed="setPersonsMetText" OnClientLoad="setPersonsMetText" >
                                       <ItemTemplate>
                            ...
                            <tr align="left">
                             ...
                             <tr align="left">
                                <td colspan="2">
                                    <label  runat="server"> Other Key Contacts </label>
                                </td>                                
                            </tr>
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;padding-bottom : 2px;">                                   
                                     <asp:TextBox id="txtKeyContactsOther" Columns = "64" MaxLength="255"  Rows="4" TextMode="MultiLine" runat="server" Text='<%# Eval("Key_Contacts_Other") %>'  runat="server"  />                                                                    
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;padding-bottom : 2px;">                                  
                                   <asp:TextBox id="txtFollowupNotesOther" Columns = "64" MaxLength="255"  Rows="4" TextMode="MultiLine"  runat="server" Text='<%# Eval("Followup_Notes_Other") %>' />                                                                
                                </td>
                            </tr>
                             <%--Follow -Up Text Field ENDS--%>
            ...
            <asp:requiredfieldvalidator ID="Requiredfieldvalidator3" controltovalidate="txtKeyContactsOther" display="none"  errormessage="Other Key Contact Required" runat="server" visible='<%# !Convert.ToBoolean(Request.QueryString["Profiled"]) %>' />
            <asp:requiredfieldvalidator ID="Requiredfieldvalidator5" controltovalidate="rdlProductsDiscussed" display="none" InitialValue="-Select Products Discussed-" errormessage="Products Discussed Required" runat="server" />
        ...
        <InsertItemTemplate>
          <table width="100%" >
            ...
            <asp:requiredfieldvalidator ID="Requiredfieldvalidator2" controltovalidate="rdlMeetingType" display="none" InitialValue="-Select Meeting Type-" errormessage="Meeting Type Required" runat="server" />
            <asp:requiredfieldvalidator ID="Requiredfieldvalidator3" controltovalidate="txtKeyContactsOther" display="none"  errormessage="Other Key Contact Required" runat="server" visible='<%# !Convert.ToBoolean(Request.QueryString["Profiled"]) %>' />
            <asp:requiredfieldvalidator ID="Requiredfieldvalidator7" controltovalidate="rdlProductsDiscussed" display="none" InitialValue="-Select Products Discussed-" errormessage="Products Discussed Required" runat="server" />
             <asp:requiredfieldvalidator ID="Requiredfieldvalidator4" controltovalidate="rdlKeyContacts" display="none" InitialValue="-Select Persons Met-" errormessage="Persons Met Required" runat="server" />
            <%--<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Persons Met Required" Display="None" ControlToValidate="rdlKeyContacts" ClientValidationFunction="chkKeyContacts"></asp:CustomValidator>--%>
            <%--<ajax:MaskedEditValidator runat="server" ID="MaskedEditValidator1" ControlExtender="MaskedEditExtender1" ControlToValidate="rdCCRDate" InvalidValueMessage='<%$ Resources:Resource, Label_Invalid_Date %>' />--%> 
            <%--<ajax:MaskedEditValidator runat="server" ID="MaskedEditValidator2" ControlExtender="MaskedEditExtender2" ControlToValidate="rdFollowUpDate" InvalidValueMessage='<%$ Resources:Resource, Label_Invalid_Date %>' />--%> 
            <%--<asp:requiredfieldvalidator ID="Requiredfieldvalidator3" controltovalidate="rdFollowUpDate" display="none" errormessage="Follow Up Date Required" runat="server" />--%>
            <asp:CompareValidator ID="comparefieldvalidator4" ControlToCompare="rdCCRDate" operator="GreaterThan" type="Date" ControlToValidate="rdFollowupDate" Display="None" ErrorMessage="Follow-up Date must be greater than the Customer Contact Report Date" runat="server" />
