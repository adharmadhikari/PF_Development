...
//        }
    ...
    function chkKeyContacts() {
        var len = $("#ctl00_main_formViewCCR_rdlKeyContacts input[type=checkbox]").length;
        var ele = document.getElementById("ctl00_main_formViewCCR_Requiredfieldvalidator4");
        if (ele != null) {
            if (len == 0) {
                ValidatorEnable(document.getElementById("ctl00_main_formViewCCR_Requiredfieldvalidator4"), false);
            }
            else {
                ValidatorEnable(document.getElementById("ctl00_main_formViewCCR_Requiredfieldvalidator4"), true);
            }
        }
    }
</script>
