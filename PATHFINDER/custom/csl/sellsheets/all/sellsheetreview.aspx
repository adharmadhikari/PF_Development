...
<%@ Register src="~/custom/csl/sellsheets/controls/SellSheetPreviewScript.ascx" tagname="SellSheetPreviewScript" tagprefix="csl" %>

<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <csl:SellSheetPreviewScript ID="SellSheetPreviewScript1" runat="server" />
</asp:Content>
