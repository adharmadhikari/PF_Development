...
public partial class custom_pinso_sellsheets_all_GenerateSellSheetPDF : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sFileName = Path.Combine(Pinsonault.Web.Support.GetClientTempFolder("SellSheets"), SheetID + "_preview");
