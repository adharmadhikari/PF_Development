...
<%@ Register src="~/custom/csl/sellsheets/controls/ReviewPlanSelectionScript.ascx" tagname="ReviewPlanSelectionScript" tagprefix="csl" %>

<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <csl:ReviewPlanSelectionScript ID="ReviewPlanSelectionScript1" runat="server" />
</asp:Content>
