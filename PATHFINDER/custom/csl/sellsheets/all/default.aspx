...
<%@ Register src="~/custom/csl/sellsheets/controls/CompletedSellSheets.ascx" tagname="CompletedSellSheets" tagprefix="csl" %>
<%@ Register src="~/custom/csl/sellsheets/controls/DraftedSellSheets.ascx" tagname="DraftedSellSheets" tagprefix="csl" %>
<%@ Register src="~/custom/csl/sellsheets/controls/SellSheetOrderList.ascx" tagname="SellSheetOrderList" tagprefix="csl" %>
<%@ Register src="~/custom/csl/sellsheets/controls/NewSellSheetOrder.ascx" tagname="NewSellSheetOrder" tagprefix="csl" %>
<%@ Register src="~/custom/csl/sellsheets/controls/SellSheetScript.ascx" tagname="SellSheetScript" tagprefix="csl" %>

<asp:Content ID="Content2" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <csl:SellSheetScript runat="server" />
    <!--[if IE 7]>
        <style type="text/css">
        #tile3 #divTile3
        {
...
<table width="100%">
    <tr>
        <td width="50%" valign="top">
            <div>
                <div class="completedSellSheet" id="completedSellSheetContainer" >                
                    <div id="CompletedSellSheetsHeader" class="tileContainerHeader">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td nowrap="nowrap" style="width: 275px">
                    ...
                    <csl:CompletedSellSheets ID="CompletedSellSheets1" runat="server"/>
                </div>
             </div>   
        </td>
        ...
        <td width="50%" valign="top">
            <div>
                ...
                <csl:DraftedSellSheets ID="DraftedSellSheets1" runat="server"/>
                </div>  
            </div>          
        </td>
    </tr>
    ...
    <tr>
        <td width="50%" valign="top">
            <csl:SellSheetOrderList ID="SellSheetOrderList1" runat="server"/>
        </td>
        <td width="50%" valign="top">
            <csl:NewSellSheetOrder ID="NewSellSheetOrder1" runat="server"/>
        </td>
    </tr>
</table>
