...
public partial class custom_csl_sellsheets_AddAccount : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rdcmbMktSegment.DataSource = access.Where(i => i.Value.ApplicationID == 1 && i.Value.Section != null && ((i.Value.SectionID == 1) || (i.Value.SectionID == 4) || (i.Value.SectionID == 12) || (i.Value.SectionID == 6))).Select(i => new { ID = i.Value.SectionID, Name = i.Value.Section.Name });
