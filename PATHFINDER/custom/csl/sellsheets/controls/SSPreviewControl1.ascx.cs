...
public partial class custom_controls_SSPreviewControl1 : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using ( PathfinderClientEntities context = new PathfinderClientEntities(Pinsonault.Web.Session.ClientConnectionString) )
        {
            ...
            //Comment out check of message as CSL gets no messages            
            ...
            //{
                ...
                msglbl.Text = "Alpha-1 - Formulary Status";
                ...
                if (ssMast.Include_Territory_Name == true)
                {
                    if (!String.IsNullOrEmpty(ssMast.Geography_Name.ToString()))
                        geolbl.Text = "[State] - Formulary Access";
                        //geolbl.Text = ssMast.Geography_Name.ToString() + " - Formulary Access";
                }
    ...
    {
        //Depending on PA/QL/ST flags show the footer-restrictionslabel.
        if (IsPA == true)
    ...
    protected void ReviewPlanListView_OnItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        if(IsPA == false)
        {
            ...
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier1lbl"))).Text.ToString().Contains("(PA)") == true)
                IsPA = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier2lbl"))).Text.ToString().Contains("(PA)") == true)
                IsPA = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier3lbl"))).Text.ToString().Contains("(PA)") == true)
                IsPA = true;
        }
        ...
        if (IsQL == false)
        {
            ...
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier1lbl"))).Text.ToString().Contains("(QL)") == true)
                IsQL = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier2lbl"))).Text.ToString().Contains("(QL)") == true)
                IsQL = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier3lbl"))).Text.ToString().Contains("(QL)") == true)
                IsQL = true;
        }
        ...
        if (IsST == false)
        {
            ...
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier1lbl"))).Text.ToString().Contains("(ST)")== true)
                IsST = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier2lbl"))).Text.ToString().Contains("(ST)") == true)
                IsST = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier3lbl"))).Text.ToString().Contains("(ST)") == true)
                IsST = true;
        }
        ...
        if (IsSpecialty == false)
        {
            ...
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier1lbl"))).Text.ToString().Trim().ToUpper() == "S")
                ...
                IsSpecialty = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier2lbl"))).Text.ToString().Trim().ToUpper() == "S")
                IsSpecialty = true;
            else if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier2lbl"))).Text.ToString().Trim().ToUpper() == "S(ST)")
                IsSpecialty = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier3lbl"))).Text.ToString().Trim().ToUpper() == "S")
                IsSpecialty = true;
            else if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier3lbl"))).Text.ToString().Trim().ToUpper() == "S(ST)")
                IsSpecialty = true;
        }
        ...
        if (IsMedical == false)
        {
            ...
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier1lbl"))).Text.ToString().Contains("M") == true)
                IsMedical = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier2lbl"))).Text.ToString().Contains("M") == true)
                IsMedical = true;
            if (((System.Web.UI.WebControls.Label)(e.Item.FindControl("Tier3lbl"))).Text.ToString().Contains("M") == true)
                IsMedical = true;
        }
        ...
        Header5.InnerHtml = lstDrugs[3].ToString();

        Header5.InnerHtml = Regex.Replace(Header5.InnerHtml, "[^\u0000-\u007F]", "&reg;");//for space
        ...
        if (IsHighlighted == true)
        {
            ...
            bool clientdrugselected = GetClientDrug_selected();
            if (clientdrugselected)
            {
    ...
    protected bool GetClientDrug_selected()
    {
        bool isClientDrug = false;
        using (SqlConnection cn = new SqlConnection(Pinsonault.Web.Session.ClientDBConnectionString))
        {
            using (SqlCommand cmd = new SqlCommand("usp_SellSheet_PlanSelectionDrugs", cn))
            {
                ...
                //set params
                cmd.Parameters.AddWithValue("@Sell_Sheet_ID", Convert.ToInt32(Request.QueryString["Sell_Sheet_ID"]));
                cmd.Parameters.AddWithValue("@User_ID", Pinsonault.Web.Session.UserID);
                cn.Open();
                SqlDataReader rdr = cmd.ExecuteReader();
                while (rdr.Read())
                {
                    isClientDrug = Convert.ToBoolean(rdr.GetString(4));
                }
            }
        }
        return isClientDrug;
