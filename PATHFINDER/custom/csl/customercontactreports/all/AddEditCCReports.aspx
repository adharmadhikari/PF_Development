<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" EnableViewState="true"
...
<asp:Content ID="Content4" ContentPlaceHolderID="main" runat="Server">
    ...
    <asp:FormView runat="server" ID="formViewCCR" CellPadding="0" Width="100%" DataSourceID="dsContactReport" DataKeyNames="Contact_Report_ID">
        <ItemTemplate>
            <table width="100%" >
                <tr>
                    <td valign="top">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;">
                                    <telerik:RadComboBox ID="rdlMeetingOutCome" runat="server" AppendDataBoundItems="true" DataSourceID="dsMeetingOutcome"
                                        ...
                                        EnableEmbeddedSkins="false" DataValueField="Meeting_Outcome_ID" AllowCustomText="True" Text="-Select Meeting Outcome-" OnClientDropDownClosed="setMeetingOutcomeText" OnClientLoad="setMeetingOutcomeText">
                                        <ItemTemplate>
...
<%--                <tr>
                    <td colspan="2" style="padding:5px">                    
                        <div class="alignLeft">Comments:</div>
                        <asp:TextBox runat="server" ID="txtComments" TextMode="MultiLine" Rows="4" Width="100%" Text='<%# Eval("Followup_Notes_Other") %>' />
                    </td>
                </tr>--%>                                    
            </table>            
            ...
            <asp:requiredfieldvalidator ID="Requiredfieldvalidator3" controltovalidate="rdlProductsDiscussed" display="none" InitialValue="-Select Products Discussed-" errormessage="Please select at least one product from the Products Discussed drop down." runat="server" />
            <asp:requiredfieldvalidator ID="Requiredfieldvalidator4" controltovalidate="rdlKeyContacts" display="none" InitialValue="-Select Persons Met-" errormessage="Please select at least one person from the Persons Met drop down." runat="server" />
            <asp:requiredfieldvalidator ID="Requiredfieldvalidator5" controltovalidate="rdlMeetingOutCome" display="none" InitialValue="-Select Meeting Outcome-" errormessage="Please select at least one Meeting Outcome from the Meeting Outcome drop down." runat="server" />
...
<%--                <tr>
                    <td colspan="2">                    
                        <asp:TextBox runat="server" ID="txtComments" TextMode="MultiLine" Rows="5" Width="100%" Text='<%# Eval("Followup_Notes_Other") %>' />
                    </td>
                </tr> --%>       
            </table>           
            <pinso:ClientValidator ID= "RequiredVal" Target="rdCCRDate" Required ="true" Text="Please select a Date" runat="server"/>
    ...
    <asp:EntityDataSource runat="server" ID="dsMeetingType" ConnectionString="name=PathfinderClientEntities"
        ...
        EntityTypeFilter="LkpMeetingType" OrderBy="it.[Meeting_Type_Name]">
    ...
    <asp:EntityDataSource runat="server" ID="dsProductsDiscussed" ConnectionString="name=PathfinderClientEntities"
        ...
        EntityTypeFilter="LkpProductsDiscussed" OrderBy="it.[Drug_Name]">
    </asp:EntityDataSource>
