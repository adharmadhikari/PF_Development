...
<table style="width:100%; padding-top: 5px;"  align="center">
    ...
    <tr>
        <td colspan="2">
            <asp:RequiredFieldValidator ControlToValidate="FileUpload1" runat="server" ErrorMessage="Please browse and enter a document to upload" />
            <asp:Label ID = "hdnLbl2" runat ="server" Text="" Visible ="false" ForeColor="Red"></asp:Label>
        </td>
    </tr>
    <tr>
        <td colspan="2">
            <asp:RequiredFieldValidator ControlToValidate="bpsName" runat="server" ErrorMessage="Please enter a document name" />
