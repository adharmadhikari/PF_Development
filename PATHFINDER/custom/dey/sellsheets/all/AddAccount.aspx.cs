...
public partial class custom_dey_sellsheets_AddAccount : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (PathfinderClientEntities context = new PathfinderClientEntities(Pinsonault.Web.Session.ClientConnectionString))
        {
            ...
            Template_ID = ss.Template_ID.Value;
        }
        ...
        if (Template_ID == 1)
            rdcmbMktSegment.DataSource = access.Where(i => i.Value.ApplicationID == 1 && i.Value.Section != null && ((i.Value.SectionID == 1) || (i.Value.SectionID == 4) || (i.Value.SectionID == 6) || (i.Value.SectionID == 9) || (i.Value.SectionID == 11) || (i.Value.SectionID == 12) || (i.Value.SectionID == 20))).Select(i => new { ID = i.Value.SectionID, Name = i.Value.Section.Name });
        else
            rdcmbMktSegment.DataSource = access.Where(i => i.Value.ApplicationID == 1 && i.Value.Section != null && i.Value.SectionID == 17).Select(i => new { ID = i.Value.SectionID, Name = i.Value.Section.Name });
