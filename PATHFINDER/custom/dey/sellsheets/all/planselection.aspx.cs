...
public partial class custom_dey_sellsheets_planselection : InputFormBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (highlight)
        {
            ...
            if (((System.Web.UI.WebControls.HiddenField)(this.formSSPlans.FindControl("hdnCopay"))).Value == "True")
            {
                ...
                gridPlanSelectionList.Columns.FindByUniqueName("FirstFormularyStatus").ItemStyle.CssClass = "yourProductLeft";

                gridPlanSelectionList.Columns.FindByUniqueName("FirstCoverageStatus").HeaderStyle.CssClass = "rgHeader planSelectHeader postback yourProductLeft";
                gridPlanSelectionList.Columns.FindByUniqueName("FirstTierName").HeaderStyle.CssClass = "rgHeader planSelectHeader postback yourProductLeft";
                gridPlanSelectionList.Columns.FindByUniqueName("FirstCopay").HeaderStyle.CssClass = "rgHeader planSelectHeader postback yourProductRight";
                gridPlanSelectionList.Columns.FindByUniqueName("FirstFormularyStatus").HeaderStyle.CssClass = "rgHeader planSelectHeader postback yourProductLeft";
                ...
                gridPlanSelectionList.Columns.FindByUniqueName("FirstFormularyStatus").FooterStyle.CssClass = "yourProductBottom";
            }
            else
            {
                ...
                gridPlanSelectionList.Columns.FindByUniqueName("FirstFormularyStatus").ItemStyle.CssClass = "yourProductSingle";

                gridPlanSelectionList.Columns.FindByUniqueName("FirstCoverageStatus").HeaderStyle.CssClass = "rgHeader planSelectHeader postback yourProductSingle";
                gridPlanSelectionList.Columns.FindByUniqueName("FirstTierName").HeaderStyle.CssClass = "rgHeader planSelectHeader postback yourProductSingle";
                gridPlanSelectionList.Columns.FindByUniqueName("FirstFormularyStatus").HeaderStyle.CssClass = "rgHeader planSelectHeader postback yourProductSingle";
