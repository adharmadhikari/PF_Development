<%@ Page Title="" Language="C#" EnableViewState="true" MasterPageFile="~/custom/dey/sellsheets/Dey_SellSheetStep.master" AutoEventWireup="true" CodeFile="marketandformularyselection.aspx.cs" Inherits="custom_dey_sellsheets_marketandformularyselection" %>
...
<div id="divIndent">
        ...
        <div class="spacedMarketRows">
            <div id="segmentInvalid" style="display: inline" >
                ...
                <asp:CheckBox ID="chkSegmentSM" runat="server" Text="State Medicaid" OnClick="updateTextbox(this, txtSegmentID);" Visible="false" CssClass="listItemWidth"/>
                <asp:CheckBox ID="chkSegmentMM" runat="server" Text="Managed Medicaid" OnClick="updateTextbox(this, txtSegmentID);" Visible="false" CssClass="listItemWidth"/>
            </div>
        </div>
        <div class="spacedMarketRows">
        ...
        <asp:EntityDataSource ID="dsSellSheetType" runat="server" EntitySetName="SellSheetTypeSet" 
            DefaultContainerName="PathfinderClientEntities" EnableUpdate="true">
