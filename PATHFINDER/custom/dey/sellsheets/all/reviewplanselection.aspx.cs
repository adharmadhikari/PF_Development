...
public partial class custom_dey_sellsheets_all_reviewplanselection : InputFormBase
{
    ...
    protected void ReviewPlanListView_OnItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        if (highlight)
        {
            ...
            if (CopayHeader1.Visible == true || Copay1Data.Visible == true)
            {
                ...
                FormularyStatusHeader1.Attributes.Add("class", "yourProductLeft");
                ...
                Formulary1Data.Attributes.Add("class", "yourProductLeft");
            ...
            else
            {
                ...
                Formulary1Data.Attributes.Add("class", "yourProductSingle");
