<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Modal.master" AutoEventWireup="true" CodeFile="AddAccount.aspx.cs" Inherits="custom_dey_sellsheets_AddAccount"  EnableViewState="true"  %>
...
<table>
    <tr>
        ...
        <td>
             <telerik:RadComboBox ID="rdcmbMktSegment" runat="server" 
                DropDownWidth="250px" Height="100px" 
    ...
    <tr>
        ...
        <td>
             <telerik:RadComboBox ID="rdcmbPlans" runat="server" 
                DropDownWidth="250px" 
                EnableEmbeddedSkins="false" SkinID="planInfoCombo" 
                Skin="pathfinder" AppendDataBoundItems="true" 
                DataSourceID="dsPlans" DataTextField="Plan_Name" DataValueField="Plan_ID" 
                OnSelectedIndexChanged="rdcmbPlans_SelectedIndexChanged" 
...
<br />
 ...
 <SelectParameters>
     ...
     <asp:ControlParameter  ControlID="rdcmbMktSegment" 
        PropertyName="SelectedValue"  Name="ID" DefaultValue="1"  Type = "Int32" /> 
 </SelectParameters>  
 </asp:SqlDataSource>   
