...
//    }
    ...
    function OpenOrderDtls()
    {
        ...
        Rep_id.clear();
        var url = "custom/Dey/sellsheets/services/DeyDataService.svc" + "/SellSheetTerritoryRepsSet?$filter=User_Level eq 2 or User_Level eq 3 & $orderby=Name";
    ...
    function rdcmbDistrict_DropDownClosed(sender, args)
    {
        ...
        if (vals != null)
        {
            ...
            url = "custom/dey/sellsheets/services/DeyDataService.svc" + "/SellSheetTerritoryRepsSet?$filter=" + eq + " or " + eq1 + " & $orderby=Name";

        }
        else
            url = "custom/dey/sellsheets/services/DeyDataService.svc" + "/SellSheetTerritoryRepsSet?$orderby=Name";
