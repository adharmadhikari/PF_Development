    ...
    <asp:FormView runat="server" ID="formViewCCR" CellPadding="0" Width="100%" DataSourceID="dsContactReport" DataKeyNames="Contact_Report_ID">
        <ItemTemplate>
                ...
                <tr>
                    <td valign="top">
                        <table align="left" >
                           ...
                           <tr align="left">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;"> 
                                    <telerik:RadComboBox ID="rdlFollowUp" runat="server" AppendDataBoundItems="true" DataSourceID="dsFollowUpNotes"
                                           DataTextField="Followup_Notes_Name" TabIndex="9" DataValueField="Followup_Notes_ID"
                            ...
                            <%--<tr align="left">
                                <td colspan="2">
                                    <label> Other Key Contacts </label>
                                </td>                                
                            </tr>
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;padding-bottom : 2px;">                                   
                                     <asp:TextBox id="txtKeyContactsOther" TabIndex="9" Columns = "64" MaxLength="255"  Rows="4" TextMode="MultiLine" runat="server" Text='<%# Eval("Key_Contacts_Other") %>' />                                                                    
                    ...
                    <td valign="top">
                        <table cellpadding="2" cellspacing="2" >
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;padding-bottom : 2px;">                                   
                                     <asp:TextBox id="txtKeyContactsOther" TabIndex="7" Columns = "64" MaxLength="255"  Rows="4" TextMode="MultiLine" runat="server" Text='<%# Eval("Key_Contacts_Other") %>' />                                                                    
                                     <pinso:MaxLengthValidator ID="MaxLengthValidator12" runat="server" ControlToValidate="txtKeyContactsOther" ErrorMessage="Key Contacts must be less than 255 characters." MaxLength="255" Display="None" />
                                </td>
                            </tr>
                            <tr align="left">
                                ...
                                <td>
                                    <asp:TextBox id="rdFollowUpDate" TabIndex="8" name="Followup_Date" runat="server" CssClass="datePicker" class="datePicker" value='<%# Eval("Followup_Date", "{0:M/dd/yyyy}") %>' />
                            ...
                            <tr>
                                <td colspan="2" style="padding-left: 5px; padding-top: 1px;">                    
                                    <div class="alignLeft">Comments:</div>
                                    <asp:TextBox runat="server" ID="txtComments" TabIndex="10" TextMode="MultiLine" Rows="4" Width="100%" Text='<%# Eval("Followup_Notes_Other") %>' />
                                </td>
                            </tr>                  
                        </table>
                    </td>                  
            ...
            <div class="modalFormButtons">
                 <pinso:CustomButton TabIndex="11" ID="btnEdit" runat="server" Text="Update" Visible="true" OnClick="Editbtn_Click" />
        ...
        <InsertItemTemplate>
          <table width="100%" >
                <tr>
                    <td valign="top">
                        <table align="left" >
                           ...
                           <tr align="left">
                            ...
                            <tr align="left">
                                <td colspan="2" style="padding-left: 5px;"> 
                                    <telerik:RadComboBox ID="rdlFollowUp" TabIndex="9" runat="server" AppendDataBoundItems="true" DataSourceID="dsFollowUpNotes"
                    ...
                    <td valign="top">
                        <table cellpadding="2" cellspacing="2" >
                            ...
                            <tr>
                                <td colspan="2" style="padding-left: 5px; padding-top: 1px;">                    
                                    <asp:TextBox runat="server" ID="txtComments" TabIndex="10" TextMode="MultiLine" Rows="5" Width="100%" Text='<%# Eval("Followup_Notes_Other") %>' />
                                </td>
                            </tr>                                              
                        </table>
                    </td>                  
            ...
            <div class="modalFormButtons">                
                <pinso:CustomButton TabIndex="11" ID="btnEdit" runat="server" Text="Add" Visible="true" OnClick="Editbtn_Click" />
                <pinso:CustomButton ID="btnReset" TabIndex="12" runat="server" Text="Reset" OnClientClick="javascript:ClearForm(); return false;" />                       
            </div>
        </InsertItemTemplate>
    </asp:FormView>
