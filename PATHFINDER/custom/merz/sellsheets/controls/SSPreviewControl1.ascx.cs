...
public partial class custom_controls_SSPreviewControl1 : System.Web.UI.UserControl
{
    ...
    protected bool IsPA = false, IsQL = false, IsST = false;
    ...
    protected void NaftinCSSClass(object sender, EventArgs e)
    {
        HtmlTable h = (HtmlTable)sender;
        ...
        string DrugName = Convert.ToString(lstDrugs[0]);

        System.Drawing.Color GreenTemplateColor = System.Drawing.ColorTranslator.FromHtml("#00704A");
        System.Drawing.Color BlueTemplateColor = System.Drawing.ColorTranslator.FromHtml("#2D58A7");

        if (DrugName == "Naftin 2%")
        {
            h.Attributes.Add("Class", "Naftin2");
            this.headerlbl.ForeColor = GreenTemplateColor;
            this.headerlbl.Text = "FORMULARY ACCESS SHEET FOR NAFTIN 2%";
            this.geolbl.ForeColor = GreenTemplateColor;
            this.pnlFooter.ForeColor = GreenTemplateColor;
            this.pnlFooter2.ForeColor = GreenTemplateColor;
            this.ReviewPlansListView.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#00704A");
           
        }
        else
        {
            h.Attributes.Add("Class", "reviewPlans");
            this.headerlbl.ForeColor = BlueTemplateColor;
            this.headerlbl.Text = "FORMULARY ACCESS SHEET FOR NAFTIN 1%";
            this.geolbl.ForeColor = BlueTemplateColor;
            this.pnlFooter.ForeColor = BlueTemplateColor;
            this.pnlFooter2.ForeColor = BlueTemplateColor;
            this.ReviewPlansListView.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#2D58A7");
        }
