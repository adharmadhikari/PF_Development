<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SingleSection.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="custom_pinso_sellsheets_sellsheets" %>
<%@ Register src="~/custom/merz/sellsheets/controls/CompletedSellSheets.ascx" tagname="CompletedSellSheets" tagprefix="merz" %>
<%@ Register src="~/custom/merz/sellsheets/controls/DraftedSellSheets.ascx" tagname="DraftedSellSheets" tagprefix="merz" %>
<%@ Register src="~/custom/merz/sellsheets/controls/SellSheetOrderList.ascx" tagname="SellSheetOrderList" tagprefix="merz" %>
<%@ Register src="~/custom/merz/sellsheets/controls/NewSellSheetOrder.ascx" tagname="NewSellSheetOrder" tagprefix="merz" %>
<%@ Register src="~/custom/merz/sellsheets/controls/SellSheetScript.ascx" tagname="SellSheetScript" tagprefix="merz" %>

<asp:Content ID="Content2" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <merz:SellSheetScript runat="server" />
    <!--[if IE 7]>
        <style type="text/css">
        #tile3 #divTile3
        {
...
<table width="100%">
    <tr>
        <td width="50%" valign="top">
            <div>
                <div class="completedSellSheet" id="completedSellSheetContainer" >                
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td nowrap="nowrap" style="width: 150px">
                                    <div class="tools" style="width: 150px">
                    ...
                    <merz:CompletedSellSheets ID="CompletedSellSheets1" runat="server"/>
                </div>
             </div>   
        </td>
        ...
        <td width="50%" valign="top">
            <div>
                ...
                <merz:DraftedSellSheets ID="DraftedSellSheets1" runat="server"/>
                </div>  
            </div>          
        </td>
    </tr>
    ...
    <tr>
        <td width="50%" valign="top">
            <merz:SellSheetOrderList ID="SellSheetOrderList1" runat="server"/>
        </td>
        <td width="50%" valign="top">
            <merz:NewSellSheetOrder ID="NewSellSheetOrder1" runat="server"/>
        </td>
    </tr>
</table>
