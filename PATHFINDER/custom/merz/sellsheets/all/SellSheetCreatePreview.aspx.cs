...
public partial class custom_merz_sellsheets_SellSheetCreatePreview : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(strTemplateName))
        {
            ...
            //                            , strServerName
            //                            , strPort
            //                            , Request.Url.AbsolutePath.Replace("custom/merz/sellsheets/all/SellSheetCreatePreview.aspx", "content/images/" + strTemplateName.ToString ())
            //                            );
