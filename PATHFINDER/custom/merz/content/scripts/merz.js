...
Pathfinder.UI.MerzFormularySellSheetsApplication = function(id)
{
    Pathfinder.UI.MerzFormularySellSheetsApplication.initializeBase(this, [id]);
};
//Pathfinder.UI.MerzFormularySellSheetsApplication.prototype =
//{
...
//        $.getJSON("custom/merz/sellsheets/services/MerzDataService.svc/CreateSellSheet?Created=" + dt, null, this._onCreateCallbackDelegate);
//    }
//};
Pathfinder.UI.MerzFormularySellSheetsApplication.registerClass("Pathfinder.UI.MerzFormularySellSheetsApplication", Pathfinder.UI.FormularySellSheetsApplication);


//Business Planning business rules ---------------------------------------------------------------------------------------------------------------------------------------------
Pathfinder.UI.MerzBusinessPlanningApplication = function(id)
{
    Pathfinder.UI.MerzBusinessPlanningApplication.initializeBase(this, [id]);
};
Pathfinder.UI.MerzBusinessPlanningApplication.prototype =
{
    ...
    getUrl: function(channelName, module, pageName, hasData, isCustom)
    {
        ...
        return Pathfinder.UI.MerzBusinessPlanningApplication.callBaseMethod(this, 'getUrl', [channelName, module, pageName, hasData, isCustom]);
    },
...
, animationSpeed);
        ...
        Pathfinder.UI.MerzBusinessPlanningApplication.callBaseMethod(this, 'resize');
    },
...
Pathfinder.UI.MerzBusinessPlanningApplication.registerClass("Pathfinder.UI.MerzBusinessPlanningApplication", Pathfinder.UI.BasicApplication);
...
function openBPUploadwindow()
{
    ...
    $openWindow("custom/merz/businessplanning/all/upload.aspx?BP_ID=" + bpid, null, null, 400, 200, "Popupwindow");
}
...
function openBPDeletewindow()
{
    ...
    $openWindow("custom/merz/businessplanning/all/RemoveMedPolicyDoc.aspx?BP_ID=" + bpid + "&MP_ID=" + mpid + "&MP_Name=" + mpname, null, null, 500, 110, "RemoveMPPopupwindow");
}
...
function gridReport_OnRowSelected(sender, args)
{
    ...
    clientManager.loadPage("custom/merz/businessplanning/all/businessplanning.aspx?report=2&Plan_ID=" + planID + "&Thera_ID=" + theraID + "&Section_ID=" + sectionID, "bpPlanInfo");
}
...
{
    //theraCtlID, sectionCtlID, planCtlID: will be set in merz/businessplanning/controls/filteraccountselection.ascx.cs
...
function onSectionListChanged(sender, args)
{
    ...
    if (val == 0) val = null;
    var url = "custom/merz/businessplanning/services/MerzDataService.svc/PlanSearch1Set?$filter=Section_ID eq " + val + "&$orderby=Name";
