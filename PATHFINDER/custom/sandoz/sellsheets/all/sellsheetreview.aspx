...
<%@ Register src="~/custom/sandoz/sellsheets/controls/SellSheetPreviewScript.ascx" tagname="SellSheetPreviewScript" tagprefix="sandoz" %>

<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <sandoz:SellSheetPreviewScript ID="SellSheetPreviewScript1" runat="server" />
</asp:Content>
