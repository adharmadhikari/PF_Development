...
<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function classTemplateSelection_pageLoaded(sender, args)
        {
            ...
            //Select Sandoz's Market Basket(TheraID: 57 for "Endocrinology(Growth Hormones)") by default.
            thera_id.selectItem(57);

            //Update hidden field with default theraid.
            $("#<%= txtTheraID.ClientID %>").val('57');
            ...
            var DefaultThera_ID = 57;

            //For selected Thera Class(TheraID: 57 for "Endocrinology(Growth Hormones)"), load the Drug List
            //if the array is undefined, create it
            if (!drugListOptions)
                drugListOptions = clientManager.get_DrugListOptions()[DefaultThera_ID];
            //..then add to it
            else
            {
                drugListOptionsConcat = drugListOptions.concat(clientManager.get_DrugListOptions()[DefaultThera_ID]);
            ...
            {
                //Select Omnitrope(DrugID: 542) by default
                drug_id.selectItem(542);
                //Update hidden field with default drugid and theraid.
                $("#<%= txtDrugID.ClientID %>").val('542|57');
            }
