...
<%@ Register src="~/custom/merz/sellsheets/controls/PlanSelectionScript.ascx" tagname="PlanSelectionScript" tagprefix="merz" %>

<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <merz:PlanSelectionScript runat="server" />
</asp:Content>
    ...
    <telerik:RadGrid SkinID="radTable"  ClientSettings-Selecting-AllowRowSelect="false" runat="server" ID="gridPlanSelectionList" AllowSorting="true"  AllowFilteringByColumn="false" EnableEmbeddedSkins="false" DataSourceID="dsSellSheetPlansList" AllowPaging="false" >        
        <MasterTableView AllowSorting="true" autogeneratecolumns="false" AllowPaging="false" PagerStyle-CssClass="postback" PageSize="10" CssClass="reviewPlans">
           <Columns >
                ...
                <telerik:GridBoundColumn DataField="Percentage_Lives" HeaderText="% of Plan Lives" UniqueName="Percentage_Lives" HeaderStyle-Width="9%" Visible="true" DataFormatString="{0}%"  ItemStyle-CssClass="alignRight"  HeaderStyle-CssClass="rgHeader planSelectHeader postback" HeaderStyle-Font-Bold="true" FooterStyle-CssClass="bottom"/>
