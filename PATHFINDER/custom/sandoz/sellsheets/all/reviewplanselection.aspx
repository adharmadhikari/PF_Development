...
<%@ Register src="~/custom/merz/sellsheets/controls/ReviewPlanSelectionScript.ascx" tagname="ReviewPlanSelectionScript" tagprefix="merz" %>

<asp:Content ID="Content1" ContentPlaceHolderID="scriptContainer" Runat="Server">
    <merz:ReviewPlanSelectionScript ID="ReviewPlanSelectionScript1" runat="server" />
</asp:Content>
    ...
    <asp:ListView runat="server" ID="ReviewPlansListView" 
        ...
        <ItemTemplate>
          <tr id="Tr1" runat="server" align="left">
              ...
              <th id="Th3" runat="server" width="7%" align="right">
